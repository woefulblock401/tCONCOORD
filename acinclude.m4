# AC_FUNC_FSEEKO has a bug in autoconf-2.61, so this is a fixed local version.
#
...
dnl
dnl @version $Id: acinclude.m4,v 1.36.2.7 2007/11/14 15:21:58 lindahl Exp $
...
# Libtool file included from libtool.m4
