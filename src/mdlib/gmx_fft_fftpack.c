/*
 * $Id: gmx_fft_fftpack.c,v 1.1.2.3 2008/02/29 07:02:51 spoel Exp $
 * 
                ...
                int            nx)
{
    ...
    *pfft = NULL;
    ...
    if( (fft->work=malloc(sizeof(real)*(4*nx))) == NULL) 
    {
        free(fft);
        return ENOMEM;
    }
                     ...
                     int           nx)
{
    ...
    *pfft = NULL;
    ...
    if((fft->work=malloc(sizeof(real)*(2*nx)))==NULL) 
    {
        free(fft);
        return ENOMEM;
    }  
                     ...
                     int           ny)
{
    ...
    *pfft = NULL;
     ...
     */
    if( (fft->work=malloc(sizeof(real)*(4*nx+2*nx*nyc))) == NULL) 
    {
        free(fft);
        return ENOMEM;
    }
                ...
                int           nz)
{
    ...
    *pfft = NULL;
     ...
     */
    if( (fft->work=malloc(sizeof(real)*(4*nx+2*nz))) == NULL) 
    {
        free(fft);
        return ENOMEM;
    }
                     ...
                     int          nz)
{
    ...
    *pfft = NULL;
     ...
     */
    if( (fft->work=malloc(sizeof(real)*(4*nx+2*nx*ny*nzc+2*nzc))) == NULL) 
    {
        free(fft);
        return ENOMEM;
    }
