/*
 * $Id: filenm.c,v 1.79.2.3 2008/02/29 07:02:43 spoel Exp $
 * 
...
static t_deffile deffile[efNR] = {
  ...
  { eftASC, ".ctp", "tdist",   NULL, "tCONCOORD Topology File"                },
  { eftASC, ".cpf", "tcnc",   NULL, "tCONCOORD Parameter File"               },
  { eftASC, ".pdbqt", "receptor",   NULL, "AutoDock PDBQT File"               },
  { eftASC, ".map", "receptor",   NULL, "AutoDock Grid Map"               }
