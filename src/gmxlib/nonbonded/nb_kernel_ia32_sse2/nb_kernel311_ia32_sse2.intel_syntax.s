;#
;# $Id: nb_kernel311_ia32_sse2.intel_syntax.s,v 1.1.2.2 2007/11/28 18:35:36 spoel Exp $
;#
...
.equiv          nb311_salign,           840
	...
	mov [esp + nb311_half+4], ebx
	movsd xmm1, [esp + nb311_half]
	...
	movapd [esp + nb311_half], xmm1
	movapd [esp + nb311_two], xmm2
	movapd [esp + nb311_three], xmm3
	movapd [esp + nb311_six], xmm4
	movapd [esp + nb311_twelve], xmm5

	mov eax, [ebp + nb311_p_tabscale]
	movsd xmm5, [eax]
	shufpd xmm5, xmm5, 0
	movapd [esp + nb311_tsc], xmm5
	...
	shufpd xmm3, xmm3, 0
	shufpd xmm4, xmm4, 0
	movapd [esp + nb311_iqO], xmm3
	movapd [esp + nb311_iqH], xmm4
...
.nb311_outer:
	...
	shufpd xmm4, xmm4, 0
	shufpd xmm5, xmm5, 0
	movapd [esp + nb311_ixO], xmm3
	movapd [esp + nb311_iyO], xmm4
	movapd [esp + nb311_izO], xmm5
	...
	shufpd xmm4, xmm4, 0
	shufpd xmm5, xmm5, 0
	movapd [esp + nb311_ixH1], xmm0
	movapd [esp + nb311_iyH1], xmm1
	movapd [esp + nb311_izH1], xmm2
	movapd [esp + nb311_ixH2], xmm3
	movapd [esp + nb311_iyH2], xmm4
	movapd [esp + nb311_izH2], xmm5
	
	;# clear vctot and i forces 
	xorpd xmm4, xmm4
	movapd [esp + nb311_vctot], xmm4
	movapd [esp + nb311_Vvdwtot], xmm4
	movapd [esp + nb311_fixO], xmm4
	movapd [esp + nb311_fiyO], xmm4
	movapd [esp + nb311_fizO], xmm4
	movapd [esp + nb311_fixH1], xmm4
	movapd [esp + nb311_fiyH1], xmm4
	movapd [esp + nb311_fizH1], xmm4
	movapd [esp + nb311_fixH2], xmm4
	movapd [esp + nb311_fiyH2], xmm4
	movapd [esp + nb311_fizH2], xmm4
...
.nb311_unroll_loop:
	...
	add dword ptr [esp + nb311_innerjjnr],  8 ;# advance pointer (unrolled 2) 
	...
	movapd xmm4, xmm3	     
	mulpd  xmm3, [esp + nb311_iqO]
	mulpd  xmm4, [esp + nb311_iqH]
	movapd  [esp + nb311_qqO], xmm3
	movapd  [esp + nb311_qqH], xmm4	
	...
	movd  eax, mm0
	movd  ebx, mm1
	movapd [esp + nb311_c6], xmm4
	movapd [esp + nb311_c12], xmm6
	...
	movapd xmm4, [esp + nb311_ixO]
	movapd xmm5, [esp + nb311_iyO]
	movapd xmm6, [esp + nb311_izO]
	...
	;# store dr 
	movapd [esp + nb311_dxO], xmm4
	movapd [esp + nb311_dyO], xmm5
	movapd [esp + nb311_dzO], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	movapd xmm4, [esp + nb311_ixH1]
	movapd xmm5, [esp + nb311_iyH1]
	movapd xmm6, [esp + nb311_izH1]
	...
	;# store dr 
	movapd [esp + nb311_dxH1], xmm4
	movapd [esp + nb311_dyH1], xmm5
	movapd [esp + nb311_dzH1], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	movapd xmm3, [esp + nb311_ixH2]
	movapd xmm4, [esp + nb311_iyH2]
	movapd xmm5, [esp + nb311_izH2]
	...
	;# store dr 
	movapd [esp + nb311_dxH2], xmm3
	movapd [esp + nb311_dyH2], xmm4
	movapd [esp + nb311_dzH2], xmm5
	;# square it 
	mulpd xmm3,xmm3
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb311_half] ;# rinv 
	movapd  [esp + nb311_rinvO], xmm4	;# rinvO in xmm4 
	mulpd   xmm7, xmm4
	movapd  [esp + nb311_rO], xmm7	;# r in xmm7 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb311_half] ;# rinv 
	movapd [esp + nb311_rinvH1], xmm4	;# rinvH1 
	mulpd  xmm6, xmm4
	movapd [esp + nb311_rH1], xmm6	;# rH1 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb311_half] ;# rinv 
	movapd [esp + nb311_rinvH2], xmm4 ;# rinv 
	mulpd xmm5, xmm4
	movapd [esp + nb311_rH2], xmm5 ;# r 

	;# do O interactions 
	;# rO is still in xmm7 
	movapd xmm0, [esp + nb311_rinvO]
	mulpd   xmm7, [esp + nb311_tsc]
    ...
    mulpd  xmm7, [esp + nb311_two]       ;# two*Heps2 
    movapd xmm0, [esp + nb311_qqO]
    addpd  xmm7, xmm6
	...
	;# do nontable L-J 
	movapd xmm2, [esp + nb311_rinvO]
	mulpd  xmm2, xmm2

    ;# at this point mm5 contains vcoul and xmm0 fijC 
    ;# increment vcoul - then we can get rid of mm5 
    addpd  xmm5, [esp + nb311_vctot]
    movapd [esp + nb311_vctot], xmm5 
	...
	mulpd  xmm1, [esp + nb311_c6]
	mulpd  xmm4, [esp + nb311_c12]
	movapd xmm3, xmm4
	subpd  xmm3, xmm1	;# xmm3=Vvdw12-Vvdw6 
	mulpd  xmm1, [esp + nb311_six]
	mulpd  xmm4, [esp + nb311_twelve]
	subpd  xmm4, xmm1
	addpd  xmm3, [esp + nb311_Vvdwtot]
	mulpd  xmm4, [esp + nb311_rinvO]
	mulpd  xmm0, [esp + nb311_tsc]
	subpd  xmm4, xmm0
	movapd [esp + nb311_Vvdwtot], xmm3
	mulpd  xmm4, [esp + nb311_rinvO]	

	movapd xmm0, [esp + nb311_dxO]
	movapd xmm1, [esp + nb311_dyO]
	movapd xmm2, [esp + nb311_dzO]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4	;# tx in xmm0-xmm2 

	;# update O forces 
	movapd xmm3, [esp + nb311_fixO]
	movapd xmm4, [esp + nb311_fiyO]
	movapd xmm7, [esp + nb311_fizO]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [esp + nb311_fixO], xmm3
	movapd [esp + nb311_fiyO], xmm4
	movapd [esp + nb311_fizO], xmm7
	;# update j forces with water O 
	movapd [esp + nb311_fjx], xmm0
	movapd [esp + nb311_fjy], xmm1
	movapd [esp + nb311_fjz], xmm2

	;# Done with O interactions - now H1! 
	movapd xmm7, [esp + nb311_rH1]
	mulpd xmm7, [esp + nb311_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	xorpd  xmm4, xmm4
    addpd  xmm5, [esp + nb311_vctot]
	mulpd  xmm3, [esp + nb311_rinvH1]
    movapd [esp + nb311_vctot], xmm5 
	mulpd  xmm3, [esp + nb311_tsc]
	subpd xmm4, xmm3

	movapd xmm0, [esp + nb311_dxH1]
	movapd xmm1, [esp + nb311_dyH1]
	movapd xmm2, [esp + nb311_dzH1]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4

	;# update H1 forces 
	movapd xmm3, [esp + nb311_fixH1]
	movapd xmm4, [esp + nb311_fiyH1]
	movapd xmm7, [esp + nb311_fizH1]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [esp + nb311_fixH1], xmm3
	movapd [esp + nb311_fiyH1], xmm4
	movapd [esp + nb311_fizH1], xmm7
	;# update j forces with water H1 
	addpd  xmm0, [esp + nb311_fjx]
	addpd  xmm1, [esp + nb311_fjy]
	addpd  xmm2, [esp + nb311_fjz]
	movapd [esp + nb311_fjx], xmm0
	movapd [esp + nb311_fjy], xmm1
	movapd [esp + nb311_fjz], xmm2

	;# Done with H1, finally we do H2 interactions 
	movapd xmm7, [esp + nb311_rH2]
	mulpd   xmm7, [esp + nb311_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	xorpd  xmm4, xmm4
    addpd  xmm5, [esp + nb311_vctot]
	mulpd  xmm3, [esp + nb311_rinvH2]
    movapd [esp + nb311_vctot], xmm5 
	mulpd  xmm3, [esp + nb311_tsc]
	subpd  xmm4, xmm3

	movapd xmm0, [esp + nb311_dxH2]
	movapd xmm1, [esp + nb311_dyH2]
	movapd xmm2, [esp + nb311_dzH2]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	;# update H2 forces 
	movapd xmm3, [esp + nb311_fixH2]
	movapd xmm4, [esp + nb311_fiyH2]
	movapd xmm7, [esp + nb311_fizH2]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [esp + nb311_fixH2], xmm3
	movapd [esp + nb311_fiyH2], xmm4
	movapd [esp + nb311_fizH2], xmm7
	...
	sub dword ptr [esp + nb311_innerk],  2
	jl    .nb311_checksingle
	jmp   .nb311_unroll_loop
.nb311_checksingle:	
	mov   edx, [esp + nb311_innerk]
	and   edx, 1
	jnz   .nb311_dosingle
...
.nb311_dosingle:
	...
	mulsd   xmm4, [esp + nb311_half] ;# iter1 ( new lu) 
	...
	mulsd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulsd xmm4, [esp + nb311_half] ;# rinv 
	movapd  [esp + nb311_rinvO], xmm4	;# rinvO in xmm4 
	mulsd   xmm7, xmm4
	movapd  [esp + nb311_rO], xmm7	;# r in xmm7 
    ...
    mulsd  xmm7, [esp + nb311_two]       ;# two*Heps2 
    movapd xmm0, [esp + nb311_qqO]
    addsd  xmm7, xmm6
    ...
    ;# at this point mm5 contains vcoul and xmm0 fijC 
    ;# increment vcoul - then we can get rid of mm5 
    addsd  xmm5, [esp + nb311_vctot]
    movlpd [esp + nb311_vctot], xmm5 
	...
	mulsd  xmm1, [esp + nb311_c6]
	mulsd  xmm4, [esp + nb311_c12]
	movapd xmm3, xmm4
	subsd  xmm3, xmm1	;# xmm3=Vvdw12-Vvdw6 
	mulsd  xmm1, [esp + nb311_six]
	mulsd  xmm4, [esp + nb311_twelve]
	subsd  xmm4, xmm1
	addsd  xmm3, [esp + nb311_Vvdwtot]
	mulsd  xmm4, [esp + nb311_rinvO]
	mulsd  xmm0, [esp + nb311_tsc]
	subsd  xmm4, xmm0
	movlpd [esp + nb311_Vvdwtot], xmm3
	mulsd  xmm4, [esp + nb311_rinvO]	
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [esp + nb311_fixO], xmm3
	movlpd [esp + nb311_fiyO], xmm4
	movlpd [esp + nb311_fizO], xmm7
	;# update j forces with water O 
	movlpd [esp + nb311_fjx], xmm0
	movlpd [esp + nb311_fjy], xmm1
	movlpd [esp + nb311_fjz], xmm2
	...
	xorpd  xmm4, xmm4
    addsd  xmm5, [esp + nb311_vctot]
	mulsd  xmm3, [esp + nb311_rinvH1]
    movlpd [esp + nb311_vctot], xmm5 
	mulsd  xmm3, [esp + nb311_tsc]
	subsd xmm4, xmm3
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [esp + nb311_fixH1], xmm3
	movlpd [esp + nb311_fiyH1], xmm4
	movlpd [esp + nb311_fizH1], xmm7
	;# update j forces with water H1 
	addsd  xmm0, [esp + nb311_fjx]
	addsd  xmm1, [esp + nb311_fjy]
	addsd  xmm2, [esp + nb311_fjz]
	movlpd [esp + nb311_fjx], xmm0
	movlpd [esp + nb311_fjy], xmm1
	movlpd [esp + nb311_fjz], xmm2
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [esp + nb311_fixH2], xmm3
	movlpd [esp + nb311_fiyH2], xmm4
	movlpd [esp + nb311_fizH2], xmm7
...
.nb311_updateouterdata:
	...
	movapd xmm0, [esp + nb311_fixO]
	movapd xmm1, [esp + nb311_fiyO]
	movapd xmm2, [esp + nb311_fizO]
	...
	movapd xmm0, [esp + nb311_fixH1]
	movapd xmm1, [esp + nb311_fiyH1]
	movapd xmm2, [esp + nb311_fizH1]
	...
	movapd xmm0, [esp + nb311_fixH2]
	movapd xmm1, [esp + nb311_fiyH2]
	movapd xmm2, [esp + nb311_fizH2]
...
.equiv          nb311nf_salign,         456
	...
	mov [esp + nb311nf_half+4], ebx
	movsd xmm1, [esp + nb311nf_half]
	shufpd xmm1, xmm1, 0    ;# splat to all elements
	movapd xmm3, xmm1
	addpd  xmm3, xmm3       ;# 1.0
	movapd xmm2, xmm3
	addpd  xmm2, xmm2       ;# 2.0
	addpd  xmm3, xmm2	;# 3.0
	movapd [esp + nb311nf_half], xmm1
	movapd [esp + nb311nf_three], xmm3

	mov eax, [ebp + nb311nf_p_tabscale]
	movsd xmm5, [eax]
	shufpd xmm5, xmm5, 0
	movapd [esp + nb311nf_tsc], xmm5
	...
	shufpd xmm3, xmm3, 0
	shufpd xmm4, xmm4, 0
	movapd [esp + nb311nf_iqO], xmm3
	movapd [esp + nb311nf_iqH], xmm4
...
.nb311nf_outer:
	...
	shufpd xmm4, xmm4, 0
	shufpd xmm5, xmm5, 0
	movapd [esp + nb311nf_ixO], xmm3
	movapd [esp + nb311nf_iyO], xmm4
	movapd [esp + nb311nf_izO], xmm5
	...
	shufpd xmm4, xmm4, 0
	shufpd xmm5, xmm5, 0
	movapd [esp + nb311nf_ixH1], xmm0
	movapd [esp + nb311nf_iyH1], xmm1
	movapd [esp + nb311nf_izH1], xmm2
	movapd [esp + nb311nf_ixH2], xmm3
	movapd [esp + nb311nf_iyH2], xmm4
	movapd [esp + nb311nf_izH2], xmm5
	
	;# clear vctot 
	xorpd xmm4, xmm4
	movapd [esp + nb311nf_vctot], xmm4
	movapd [esp + nb311nf_Vvdwtot], xmm4
...
.nb311nf_unroll_loop:
	...
	add dword ptr [esp + nb311nf_innerjjnr],  8 ;# advance pointer (unrolled 2) 
	...
	movhpd xmm3, [esi + ebx*8]
	movapd xmm4, xmm3	     
	mulpd  xmm3, [esp + nb311nf_iqO]
	mulpd  xmm4, [esp + nb311nf_iqH]

	movd  mm0, eax		;# use mmx registers as temp storage 
	movd  mm1, ebx

	movapd  [esp + nb311nf_qqO], xmm3
	movapd  [esp + nb311nf_qqH], xmm4	
	...
	movd  eax, mm0
	movd  ebx, mm1
	movapd [esp + nb311nf_c6], xmm4
	movapd [esp + nb311nf_c12], xmm6
	...
	;# move ixO-izO to xmm4-xmm6 
	movapd xmm4, [esp + nb311nf_ixO]
	movapd xmm5, [esp + nb311nf_iyO]
	movapd xmm6, [esp + nb311nf_izO]
	...
	;# move ixH1-izH1 to xmm4-xmm6 
	movapd xmm4, [esp + nb311nf_ixH1]
	movapd xmm5, [esp + nb311nf_iyH1]
	movapd xmm6, [esp + nb311nf_izH1]
	...
	;# move ixH2-izH2 to xmm3-xmm5  
	movapd xmm3, [esp + nb311nf_ixH2]
	movapd xmm4, [esp + nb311nf_iyH2]
	movapd xmm5, [esp + nb311nf_izH2]
	...
	movapd  xmm3, xmm2
	mulpd   xmm2, xmm2
	movapd  xmm4, [esp + nb311nf_three]
	mulpd   xmm2, xmm7	;# rsq*lu*lu 
	subpd   xmm4, xmm2	;# 30-rsq*lu*lu 
	mulpd   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulpd   xmm4, [esp + nb311nf_half] ;# iter1 ( new lu) 
	...
	subpd xmm4, xmm2	;# 3-rsq*lu*lu 
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb311nf_half] ;# rinv 
	movapd  [esp + nb311nf_rinvO], xmm4	;# rinvO in xmm4 
	mulpd   xmm7, xmm4
	movapd  [esp + nb311nf_rO], xmm7	;# r in xmm7 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb311nf_half] ;# rinv 
	movapd [esp + nb311nf_rinvH1], xmm4	;# rinvH1 
	mulpd  xmm6, xmm4
	movapd [esp + nb311nf_rH1], xmm6	;# rH1 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb311nf_half] ;# rinv 
	movapd [esp + nb311nf_rinvH2], xmm4 ;# rinv 
	mulpd xmm5, xmm4
	movapd [esp + nb311nf_rH2], xmm5 ;# r 

	;# do O interactions 
	;# rO is still in xmm7 
	movapd xmm0, [esp + nb311nf_rinvO]
	mulpd   xmm7, [esp + nb311nf_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	movapd xmm1, xmm7	;# xmm1=eps 
    ...
    addpd  xmm5, xmm6
    addpd  xmm5, xmm7       ;# xmm5=Fp        
    movapd xmm0, [esp + nb311nf_qqO]
    mulpd  xmm5, xmm1 ;# xmm5=eps*Fp 
    addpd  xmm5, xmm4 ;# xmm5=VV 
    mulpd  xmm5, xmm0 ;# vcoul=qq*VV  

	;# do nontable L-J 
	movapd xmm2, [esp + nb311nf_rinvO]
	mulpd  xmm2, xmm2

    ;# at this point mm5 contains vcoul and xmm0 fijC 
    ;# increment vcoul - then we can get rid of mm5 
    addpd  xmm5, [esp + nb311nf_vctot]
    movapd [esp + nb311nf_vctot], xmm5 
	...
	movapd xmm4, xmm1
	mulpd  xmm4, xmm4	;# xmm4=rinvtwelve 
	mulpd  xmm1, [esp + nb311nf_c6]
	mulpd  xmm4, [esp + nb311nf_c12]
	movapd xmm3, xmm4
	subpd  xmm3, xmm1	;# xmm3=Vvdw12-Vvdw6 
	addpd  xmm3, [esp + nb311nf_Vvdwtot]
	movapd [esp + nb311nf_Vvdwtot], xmm3
	

	;# Done with O interactions - now H1! 
	movapd xmm7, [esp + nb311nf_rH1]
	mulpd xmm7, [esp + nb311nf_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	;# should we do one more iteration? 
	sub dword ptr [esp + nb311nf_innerk],  2
	jl    .nb311nf_checksingle
	jmp   .nb311nf_unroll_loop
.nb311nf_checksingle:	
	mov   edx, [esp + nb311nf_innerk]
	and   edx, 1
...
.nb311nf_dosingle:
	...
	subsd   xmm4, xmm2	;# 30-rsq*lu*lu 
	mulsd   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulsd   xmm4, [esp + nb311nf_half] ;# iter1 ( new lu) 
	...
	subsd xmm4, xmm2	;# 3-rsq*lu*lu 
	mulsd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulsd xmm4, [esp + nb311nf_half] ;# rinv 
	movapd  [esp + nb311nf_rinvO], xmm4	;# rinvO in xmm4 
	mulsd   xmm7, xmm4
	movapd  [esp + nb311nf_rO], xmm7	;# r in xmm7 
    ...
    ;# at this point mm5 contains vcoul 
    ;# increment vcoul - then we can get rid of mm5 
    addsd  xmm5, [esp + nb311nf_vctot]
    movlpd [esp + nb311nf_vctot], xmm5 
	...
	movapd xmm4, xmm1
	mulsd  xmm4, xmm4	;# xmm4=rinvtwelve 
	mulsd  xmm1, [esp + nb311nf_c6]
	mulsd  xmm4, [esp + nb311nf_c12]
	movapd xmm3, xmm4
	subsd  xmm3, xmm1	;# xmm3=Vvdw12-Vvdw6 
	addsd  xmm3, [esp + nb311nf_Vvdwtot]
	movlpd [esp + nb311nf_Vvdwtot], xmm3
...
.nb311nf_updateouterdata:
	...
	;# accumulate total lj energy and update it 
	movapd xmm7, [esp + nb311nf_Vvdwtot]
	;# accumulate 
	movhlps xmm6, xmm7
	addsd  xmm7, xmm6	;# low xmm7 has the sum now 
