;#
;# $Id: nb_kernel331_ia32_sse2.intel_syntax.s,v 1.1.2.2 2007/11/28 18:35:36 spoel Exp $
;#
...
.equiv          nb331_salign,           808
	...
	mov [esp + nb331_half+4], ebx
	movsd xmm1, [esp + nb331_half]
	...
	addpd  xmm2, xmm2       ;# 2.0
	addpd  xmm3, xmm2	;# 3.0
	movapd [esp + nb331_half], xmm1
	movapd [esp + nb331_two], xmm2
	movapd [esp + nb331_three], xmm3
	mov eax, [ebp + nb331_p_tabscale]
	movsd xmm5, [eax]
	shufpd xmm5, xmm5, 0
	movapd [esp + nb331_tsc], xmm5
	...
	shufpd xmm3, xmm3, 0
	shufpd xmm4, xmm4, 0
	movapd [esp + nb331_iqO], xmm3
	movapd [esp + nb331_iqH], xmm4
...
.nb331_outer:
	...
	shufpd xmm4, xmm4, 0
	shufpd xmm5, xmm5, 0
	movapd [esp + nb331_ixO], xmm3
	movapd [esp + nb331_iyO], xmm4
	movapd [esp + nb331_izO], xmm5
	...
	shufpd xmm4, xmm4, 0
	shufpd xmm5, xmm5, 0
	movapd [esp + nb331_ixH1], xmm0
	movapd [esp + nb331_iyH1], xmm1
	movapd [esp + nb331_izH1], xmm2
	movapd [esp + nb331_ixH2], xmm3
	movapd [esp + nb331_iyH2], xmm4
	movapd [esp + nb331_izH2], xmm5
	
	;# clear vctot and i forces 
	xorpd xmm4, xmm4
	movapd [esp + nb331_vctot], xmm4
	movapd [esp + nb331_Vvdwtot], xmm4
	movapd [esp + nb331_fixO], xmm4
	movapd [esp + nb331_fiyO], xmm4
	movapd [esp + nb331_fizO], xmm4
	movapd [esp + nb331_fixH1], xmm4
	movapd [esp + nb331_fiyH1], xmm4
	movapd [esp + nb331_fizH1], xmm4
	movapd [esp + nb331_fixH2], xmm4
	movapd [esp + nb331_fiyH2], xmm4
	movapd [esp + nb331_fizH2], xmm4
...
.nb331_unroll_loop:
	...
	add dword ptr [esp + nb331_innerjjnr],  8 ;# advance pointer (unrolled 2) 
	...
	movapd xmm4, xmm3	     
	mulpd  xmm3, [esp + nb331_iqO]
	mulpd  xmm4, [esp + nb331_iqH]
	movapd  [esp + nb331_qqO], xmm3
	movapd  [esp + nb331_qqH], xmm4	
	...
	movd  eax, mm0
	movd  ebx, mm1
	movapd [esp + nb331_c6], xmm4
	movapd [esp + nb331_c12], xmm6
	...
	movapd xmm4, [esp + nb331_ixO]
	movapd xmm5, [esp + nb331_iyO]
	movapd xmm6, [esp + nb331_izO]
	...
	;# store dr 
	movapd [esp + nb331_dxO], xmm4
	movapd [esp + nb331_dyO], xmm5
	movapd [esp + nb331_dzO], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	movapd xmm4, [esp + nb331_ixH1]
	movapd xmm5, [esp + nb331_iyH1]
	movapd xmm6, [esp + nb331_izH1]
	...
	;# store dr 
	movapd [esp + nb331_dxH1], xmm4
	movapd [esp + nb331_dyH1], xmm5
	movapd [esp + nb331_dzH1], xmm6
	;# square it 
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	mulpd xmm6,xmm6
	...
	movapd xmm3, [esp + nb331_ixH2]
	movapd xmm4, [esp + nb331_iyH2]
	movapd xmm5, [esp + nb331_izH2]
	...
	;# store dr 
	movapd [esp + nb331_dxH2], xmm3
	movapd [esp + nb331_dyH2], xmm4
	movapd [esp + nb331_dzH2], xmm5
	;# square it 
	mulpd xmm3,xmm3
	mulpd xmm4,xmm4
	mulpd xmm5,xmm5
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb331_half] ;# rinv 
	movapd  [esp + nb331_rinvO], xmm4	;# rinvO in xmm4 
	mulpd   xmm7, xmm4
	movapd  [esp + nb331_rO], xmm7	;# r in xmm7 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb331_half] ;# rinv 
	movapd [esp + nb331_rinvH1], xmm4	;# rinvH1 
	mulpd  xmm6, xmm4
	movapd [esp + nb331_rH1], xmm6	;# rH1 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb331_half] ;# rinv 
	movapd [esp + nb331_rinvH2], xmm4 ;# rinv 
	mulpd xmm5, xmm4
	movapd [esp + nb331_rH2], xmm5 ;# r 

	;# do O interactions 
	;# rO is still in xmm7 
	movapd xmm0, [esp + nb331_rinvO]
	mulpd   xmm7, [esp + nb331_tsc]
    ...
    mulpd  xmm7, [esp + nb331_two]       ;# two*Heps2 
    movapd xmm0, [esp + nb331_qqO]
    addpd  xmm7, xmm6
	...
	;# update vctot 
	addpd  xmm5, [esp + nb331_vctot]
	movapd [esp + nb331_vctot], xmm5 
	...
	movapd xmm4, [esp + nb331_c6]
	mulpd  xmm7, xmm4	 ;# fijD 
	mulpd  xmm5, xmm4	 ;# Vvdw6 
	addpd  xmm0, xmm7	;# fscal summation 
		
	addpd  xmm5, [esp + nb331_Vvdwtot]
	movapd [esp + nb331_Vvdwtot], xmm5
	...
	xorpd xmm4, xmm4
	subpd xmm4, xmm7
	movapd xmm0, [esp + nb331_dxO]
	movapd xmm1, [esp + nb331_dyO]
	movapd xmm2, [esp + nb331_dzO]
	...
	;# update O forces 
	movapd xmm3, [esp + nb331_fixO]
	movapd xmm4, [esp + nb331_fiyO]
	movapd xmm7, [esp + nb331_fizO]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [esp + nb331_fixO], xmm3
	movapd [esp + nb331_fiyO], xmm4
	movapd [esp + nb331_fizO], xmm7
	;# update j forces with water O 
	movapd [esp + nb331_fjx], xmm0
	movapd [esp + nb331_fjy], xmm1
	movapd [esp + nb331_fjz], xmm2

	;# Done with O interactions - now H1! 
	movapd xmm7, [esp + nb331_rH1]
	mulpd xmm7, [esp + nb331_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	xorpd  xmm4, xmm4
    addpd  xmm5, [esp + nb331_vctot]
	mulpd  xmm3, [esp + nb331_rinvH1]
    movapd [esp + nb331_vctot], xmm5 
	mulpd  xmm3, [esp + nb331_tsc]
	subpd xmm4, xmm3

	movapd xmm0, [esp + nb331_dxH1]
	movapd xmm1, [esp + nb331_dyH1]
	movapd xmm2, [esp + nb331_dzH1]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4

	;# update H1 forces 
	movapd xmm3, [esp + nb331_fixH1]
	movapd xmm4, [esp + nb331_fiyH1]
	movapd xmm7, [esp + nb331_fizH1]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [esp + nb331_fixH1], xmm3
	movapd [esp + nb331_fiyH1], xmm4
	movapd [esp + nb331_fizH1], xmm7
	;# update j forces with water H1 
	addpd  xmm0, [esp + nb331_fjx]
	addpd  xmm1, [esp + nb331_fjy]
	addpd  xmm2, [esp + nb331_fjz]
	movapd [esp + nb331_fjx], xmm0
	movapd [esp + nb331_fjy], xmm1
	movapd [esp + nb331_fjz], xmm2

	;# Done with H1, finally we do H2 interactions 
	movapd xmm7, [esp + nb331_rH2]
	mulpd   xmm7, [esp + nb331_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	xorpd  xmm4, xmm4
    addpd  xmm5, [esp + nb331_vctot]
	mulpd  xmm3, [esp + nb331_rinvH2]
    movapd [esp + nb331_vctot], xmm5 
	mulpd  xmm3, [esp + nb331_tsc]
	subpd  xmm4, xmm3

	movapd xmm0, [esp + nb331_dxH2]
	movapd xmm1, [esp + nb331_dyH2]
	movapd xmm2, [esp + nb331_dzH2]
	mulpd  xmm0, xmm4
	mulpd  xmm1, xmm4
	mulpd  xmm2, xmm4
	...
	;# update H2 forces 
	movapd xmm3, [esp + nb331_fixH2]
	movapd xmm4, [esp + nb331_fiyH2]
	movapd xmm7, [esp + nb331_fizH2]
	addpd  xmm3, xmm0
	addpd  xmm4, xmm1
	addpd  xmm7, xmm2
	movapd [esp + nb331_fixH2], xmm3
	movapd [esp + nb331_fiyH2], xmm4
	movapd [esp + nb331_fizH2], xmm7
	...
	sub dword ptr [esp + nb331_innerk],  2
	jl    .nb331_checksingle
	jmp   .nb331_unroll_loop
.nb331_checksingle:	
	mov   edx, [esp + nb331_innerk]
	and   edx, 1
	jnz   .nb331_dosingle
...
.nb331_dosingle:
	...
	mulsd   xmm4, [esp + nb331_half] ;# iter1 ( new lu) 
	...
	mulsd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulsd xmm4, [esp + nb331_half] ;# rinv 
	movapd  [esp + nb331_rinvO], xmm4	;# rinvO in xmm4 
	mulsd   xmm7, xmm4
	movapd  [esp + nb331_rO], xmm7	;# r in xmm7 
    ...
    mulsd  xmm7, [esp + nb331_two]       ;# two*Heps2 
	...
	;# increment vcoul - then we can get rid of mm5 
	;# update vctot 
	addsd  xmm5, [esp + nb331_vctot]
	movlpd [esp + nb331_vctot], xmm5 
	...
	addsd  xmm5, [esp + nb331_Vvdwtot]
	movsd [esp + nb331_Vvdwtot], xmm5
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [esp + nb331_fixO], xmm3
	movlpd [esp + nb331_fiyO], xmm4
	movlpd [esp + nb331_fizO], xmm7
	;# update j forces with water O 
	movlpd [esp + nb331_fjx], xmm0
	movlpd [esp + nb331_fjy], xmm1
	movlpd [esp + nb331_fjz], xmm2
	...
	xorpd  xmm4, xmm4
    addsd  xmm5, [esp + nb331_vctot]
	mulsd  xmm3, [esp + nb331_rinvH1]
    movlpd [esp + nb331_vctot], xmm5 
	mulsd  xmm3, [esp + nb331_tsc]
	subsd xmm4, xmm3
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [esp + nb331_fixH1], xmm3
	movlpd [esp + nb331_fiyH1], xmm4
	movlpd [esp + nb331_fizH1], xmm7
	;# update j forces with water H1 
	addsd  xmm0, [esp + nb331_fjx]
	addsd  xmm1, [esp + nb331_fjy]
	addsd  xmm2, [esp + nb331_fjz]
	movlpd [esp + nb331_fjx], xmm0
	movlpd [esp + nb331_fjy], xmm1
	movlpd [esp + nb331_fjz], xmm2
	...
	addsd  xmm4, xmm1
	addsd  xmm7, xmm2
	movlpd [esp + nb331_fixH2], xmm3
	movlpd [esp + nb331_fiyH2], xmm4
	movlpd [esp + nb331_fizH2], xmm7
...
.nb331_updateouterdata:
	...
	movapd xmm0, [esp + nb331_fixO]
	movapd xmm1, [esp + nb331_fiyO]
	movapd xmm2, [esp + nb331_fizO]
	...
	movapd xmm0, [esp + nb331_fixH1]
	movapd xmm1, [esp + nb331_fiyH1]
	movapd xmm2, [esp + nb331_fizH1]
	...
	movapd xmm0, [esp + nb331_fixH2]
	movapd xmm1, [esp + nb331_fiyH2]
	movapd xmm2, [esp + nb331_fizH2]
...
.equiv          nb331nf_salign,         456
	...
	mov [esp + nb331nf_half+4], ebx
	movsd xmm1, [esp + nb331nf_half]
	shufpd xmm1, xmm1, 0    ;# splat to all elements
	movapd xmm3, xmm1
	addpd  xmm3, xmm3       ;# 1.0
	movapd xmm2, xmm3
	addpd  xmm2, xmm2       ;# 2.0
	addpd  xmm3, xmm2	;# 3.0
	movapd [esp + nb331nf_half], xmm1
	movapd [esp + nb331nf_three], xmm3
	mov eax, [ebp + nb331nf_p_tabscale]
	movsd xmm5, [eax]
	shufpd xmm5, xmm5, 0
	movapd [esp + nb331nf_tsc], xmm5
	...
	shufpd xmm3, xmm3, 0
	shufpd xmm4, xmm4, 0
	movapd [esp + nb331nf_iqO], xmm3
	movapd [esp + nb331nf_iqH], xmm4
...
.nb331nf_outer:
	...
	shufpd xmm4, xmm4, 0
	shufpd xmm5, xmm5, 0
	movapd [esp + nb331nf_ixO], xmm3
	movapd [esp + nb331nf_iyO], xmm4
	movapd [esp + nb331nf_izO], xmm5
	...
	shufpd xmm4, xmm4, 0
	shufpd xmm5, xmm5, 0
	movapd [esp + nb331nf_ixH1], xmm0
	movapd [esp + nb331nf_iyH1], xmm1
	movapd [esp + nb331nf_izH1], xmm2
	movapd [esp + nb331nf_ixH2], xmm3
	movapd [esp + nb331nf_iyH2], xmm4
	movapd [esp + nb331nf_izH2], xmm5
	
	;# clear vctot 
	xorpd xmm4, xmm4
	movapd [esp + nb331nf_vctot], xmm4
	movapd [esp + nb331nf_Vvdwtot], xmm4
...
.nb331nf_unroll_loop:
	...
	add dword ptr [esp + nb331nf_innerjjnr],  8 ;# advance pointer (unrolled 2) 
	...
	movhpd xmm3, [esi + ebx*8]
	movapd xmm4, xmm3	     
	mulpd  xmm3, [esp + nb331nf_iqO]
	mulpd  xmm4, [esp + nb331nf_iqH]
	movapd  [esp + nb331nf_qqO], xmm3
	movapd  [esp + nb331nf_qqH], xmm4	
	...
	movd  eax, mm0
	movd  ebx, mm1
	movapd [esp + nb331nf_c6], xmm4
	movapd [esp + nb331nf_c12], xmm6
	...
	;# move ixO-izO to xmm4-xmm6 
	movapd xmm4, [esp + nb331nf_ixO]
	movapd xmm5, [esp + nb331nf_iyO]
	movapd xmm6, [esp + nb331nf_izO]
	...
	;# move ixH1-izH1 to xmm4-xmm6 
	movapd xmm4, [esp + nb331nf_ixH1]
	movapd xmm5, [esp + nb331nf_iyH1]
	movapd xmm6, [esp + nb331nf_izH1]
	...
	;# move ixH2-izH2 to xmm3-xmm5  
	movapd xmm3, [esp + nb331nf_ixH2]
	movapd xmm4, [esp + nb331nf_iyH2]
	movapd xmm5, [esp + nb331nf_izH2]
	...
	movapd  xmm3, xmm2
	mulpd   xmm2, xmm2
	movapd  xmm4, [esp + nb331nf_three]
	mulpd   xmm2, xmm7	;# rsq*lu*lu 
	subpd   xmm4, xmm2	;# 30-rsq*lu*lu 
	mulpd   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulpd   xmm4, [esp + nb331nf_half] ;# iter1 ( new lu) 
	...
	subpd xmm4, xmm2	;# 3-rsq*lu*lu 
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb331nf_half] ;# rinv 
	movapd  [esp + nb331nf_rinvO], xmm4	;# rinvO in xmm4 
	mulpd   xmm7, xmm4
	movapd  [esp + nb331nf_rO], xmm7	;# r in xmm7 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb331nf_half] ;# rinv 
	movapd [esp + nb331nf_rinvH1], xmm4	;# rinvH1 
	mulpd  xmm6, xmm4
	movapd [esp + nb331nf_rH1], xmm6	;# rH1 
	...
	mulpd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulpd xmm4, [esp + nb331nf_half] ;# rinv 
	movapd [esp + nb331nf_rinvH2], xmm4 ;# rinv 
	mulpd xmm5, xmm4
	movapd [esp + nb331nf_rH2], xmm5 ;# r 

	;# do O interactions 
	;# rO is still in xmm7 
	movapd xmm0, [esp + nb331nf_rinvO]
	mulpd   xmm7, [esp + nb331nf_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	movapd xmm1, xmm7	;# xmm1=eps 
	...
	;# increment vcoul - then we can get rid of mm5 
	;# update vctot 
	addpd  xmm5, [esp + nb331nf_vctot]
	movapd [esp + nb331nf_vctot], xmm5 
	...
	mulpd  xmm5, [esp + nb331nf_c6]	 ;# Vvdw6 
		
	addpd  xmm5, [esp + nb331nf_Vvdwtot]
	movapd [esp + nb331nf_Vvdwtot], xmm5
	...
	mulpd  xmm5, [esp + nb331nf_c12] ;# Vvdw12 
	addpd  xmm5, [esp + nb331nf_Vvdwtot]
	movapd [esp + nb331nf_Vvdwtot], xmm5

	;# Done with O interactions - now H1! 
	movapd xmm7, [esp + nb331nf_rH1]
	mulpd xmm7, [esp + nb331nf_tsc]
	cvttpd2pi mm6, xmm7	;# mm6 = lu idx 
	cvtpi2pd xmm6, mm6
	subpd xmm7, xmm6
	...
	;# should we do one more iteration? 
	sub dword ptr [esp + nb331nf_innerk],  2
	jl    .nb331nf_checksingle
	jmp   .nb331nf_unroll_loop
.nb331nf_checksingle:	
	mov   edx, [esp + nb331nf_innerk]
	and   edx, 1
...
.nb331nf_dosingle:
	...
	subsd   xmm4, xmm2	;# 30-rsq*lu*lu 
	mulsd   xmm4, xmm3	;# lu*(3-rsq*lu*lu) 
	mulsd   xmm4, [esp + nb331nf_half] ;# iter1 ( new lu) 
	...
	subsd xmm4, xmm2	;# 3-rsq*lu*lu 
	mulsd xmm4, xmm3	;# lu*(	3-rsq*lu*lu) 
	mulsd xmm4, [esp + nb331nf_half] ;# rinv 
	movapd  [esp + nb331nf_rinvO], xmm4	;# rinvO in xmm4 
	mulsd   xmm7, xmm4
	movapd  [esp + nb331nf_rO], xmm7	;# r in xmm7 
	...
	;# increment vcoul - then we can get rid of mm5 
	;# update vctot 
	addsd  xmm5, [esp + nb331nf_vctot]
	movlpd [esp + nb331nf_vctot], xmm5 
	...
	mulsd  xmm5, [esp + nb331nf_c6]	 ;# Vvdw6 
		
	addsd  xmm5, [esp + nb331nf_Vvdwtot]
	movsd [esp + nb331nf_Vvdwtot], xmm5
	...
	mulsd  xmm5, [esp + nb331nf_c12] ;# Vvdw12 
...
.nb331nf_updateouterdata:
	...
	;# accumulate total lj energy and update it 
	movapd xmm7, [esp + nb331nf_Vvdwtot]
	;# accumulate 
	movhlps xmm6, xmm7
	addsd  xmm7, xmm6	;# low xmm7 has the sum now 
