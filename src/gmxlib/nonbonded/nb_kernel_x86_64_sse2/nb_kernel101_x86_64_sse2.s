...
_nb_kernel101_x86_64_sse2.nb101_unroll_loop: 
    ...
    mulpd  %xmm10,%xmm10
    mulpd  %xmm11,%xmm11
    mulpd  nb101_qqO(%rsp),%xmm0
    mulpd  nb101_qqH(%rsp),%xmm1
    mulpd  nb101_qqH(%rsp),%xmm2
    mulpd  %xmm0,%xmm9
    mulpd  %xmm1,%xmm10
    mulpd  %xmm2,%xmm11

    addpd nb101_vctot(%rsp),%xmm0
    addpd %xmm2,%xmm1
    addpd %xmm1,%xmm0
    movapd %xmm0,nb101_vctot(%rsp)
    ...
    movapd %xmm10,%xmm12
        ...
        mulpd nb101_dxO(%rsp),%xmm7
        mulpd nb101_dyO(%rsp),%xmm8
        mulpd nb101_dzO(%rsp),%xmm9
        mulpd nb101_dxH1(%rsp),%xmm10
        mulpd nb101_dyH1(%rsp),%xmm11
        mulpd nb101_dzH1(%rsp),%xmm12
        mulpd nb101_dxH2(%rsp),%xmm13
        mulpd nb101_dyH2(%rsp),%xmm14
        mulpd nb101_dzH2(%rsp),%xmm15

    addpd %xmm7,%xmm0
    addpd %xmm8,%xmm1
    addpd %xmm9,%xmm2
    addpd nb101_fixO(%rsp),%xmm7
    addpd nb101_fiyO(%rsp),%xmm8
    addpd nb101_fizO(%rsp),%xmm9

    addpd %xmm10,%xmm0
    addpd %xmm11,%xmm1
    addpd %xmm12,%xmm2
    addpd nb101_fixH1(%rsp),%xmm10
    addpd nb101_fiyH1(%rsp),%xmm11
    addpd nb101_fizH1(%rsp),%xmm12

    addpd %xmm13,%xmm0
    addpd %xmm14,%xmm1
    addpd %xmm15,%xmm2
    addpd nb101_fixH2(%rsp),%xmm13
    addpd nb101_fiyH2(%rsp),%xmm14
    addpd nb101_fizH2(%rsp),%xmm15

    movapd %xmm7,nb101_fixO(%rsp)
    movapd %xmm8,nb101_fiyO(%rsp)
    movapd %xmm9,nb101_fizO(%rsp)
    movapd %xmm10,nb101_fixH1(%rsp)
    movapd %xmm11,nb101_fiyH1(%rsp)
    movapd %xmm12,nb101_fizH1(%rsp)
    movapd %xmm13,nb101_fixH2(%rsp)
    movapd %xmm14,nb101_fiyH2(%rsp)
    movapd %xmm15,nb101_fizH2(%rsp)
    ...
    ## store back j forces from xmm0-xmm2
        ...
        subl $2,nb101_innerk(%rsp)
        jl    _nb_kernel101_x86_64_sse2.nb101_checksingle
        jmp   _nb_kernel101_x86_64_sse2.nb101_unroll_loop
_nb_kernel101_x86_64_sse2.nb101_checksingle:    
        movl  nb101_innerk(%rsp),%edx
        andl  $1,%edx
        jnz    _nb_kernel101_x86_64_sse2.nb101_dosingle
        jmp    _nb_kernel101_x86_64_sse2.nb101_updateouterdata
_nb_kernel101_x86_64_sse2.nb101_dosingle: 
        movq  nb101_innerjjnr(%rsp),%rdx       ## pointer to jjnr[k] 
        movl  (%rdx),%eax
    ...
    movapd %xmm6,%xmm2
        ...
        ## calc dr 
        subsd nb101_ixO(%rsp),%xmm4
        subsd nb101_iyO(%rsp),%xmm5
        subsd nb101_izO(%rsp),%xmm6


        ## store dr 
        movapd %xmm4,nb101_dxO(%rsp)
        movapd %xmm5,nb101_dyO(%rsp)
        movapd %xmm6,nb101_dzO(%rsp)
        ## square it 
        mulsd %xmm4,%xmm4
        mulsd %xmm5,%xmm5
        mulsd %xmm6,%xmm6
        ...
        ## calc dr 
        subsd nb101_ixH1(%rsp),%xmm4
        subsd nb101_iyH1(%rsp),%xmm5
        subsd nb101_izH1(%rsp),%xmm6

        ## store dr 
        movapd %xmm4,nb101_dxH1(%rsp)
        movapd %xmm5,nb101_dyH1(%rsp)
        movapd %xmm6,nb101_dzH1(%rsp)
        ## square it 
        mulsd %xmm4,%xmm4
        mulsd %xmm5,%xmm5
        mulsd %xmm6,%xmm6
        ...
        ## calc dr 
        subsd nb101_ixH2(%rsp),%xmm3
        subsd nb101_iyH2(%rsp),%xmm4
        subsd nb101_izH2(%rsp),%xmm5

        ## store dr 
        movapd %xmm3,nb101_dxH2(%rsp)
        movapd %xmm4,nb101_dyH2(%rsp)
        movapd %xmm5,nb101_dzH2(%rsp)
        ## square it 
        mulsd %xmm3,%xmm3
        mulsd %xmm4,%xmm4
        mulsd %xmm5,%xmm5
        ...
        mulsd %xmm3,%xmm4       ## lu*( 3-rsq*lu*lu) 
        mulsd nb101_half(%rsp),%xmm4   ## rinv 
        ...
        mulsd  nb101_qqO(%rsp),%xmm7    ## xmm7=vcoul 

        mulsd  %xmm7,%xmm4      ## total fsO in xmm4 

        addsd  nb101_vctot(%rsp),%xmm7

        movlpd %xmm7,nb101_vctot(%rsp)

        movapd nb101_dxO(%rsp),%xmm0
        movapd nb101_dyO(%rsp),%xmm1
        movapd nb101_dzO(%rsp),%xmm2
        mulsd  %xmm4,%xmm0
        mulsd  %xmm4,%xmm1
        mulsd  %xmm4,%xmm2

        ## update O forces 
        movapd nb101_fixO(%rsp),%xmm3
        movapd nb101_fiyO(%rsp),%xmm4
        movapd nb101_fizO(%rsp),%xmm7
        addsd  %xmm0,%xmm3
        addsd  %xmm1,%xmm4
        addsd  %xmm2,%xmm7
        movlpd %xmm3,nb101_fixO(%rsp)
        movlpd %xmm4,nb101_fiyO(%rsp)
        movlpd %xmm7,nb101_fizO(%rsp)
        ## update j forces with water O 
        movlpd %xmm0,nb101_fjx(%rsp)
        movlpd %xmm1,nb101_fjy(%rsp)
        movlpd %xmm2,nb101_fjz(%rsp)

        ## H1 interactions 
        movapd  %xmm6,%xmm4
        mulsd   %xmm4,%xmm4     ## xmm6=rinv, xmm4=rinvsq 
        mulsd  nb101_qqH(%rsp),%xmm6    ## xmm6=vcoul 
        mulsd  %xmm6,%xmm4              ## total fsH1 in xmm4 

        addsd  nb101_vctot(%rsp),%xmm6

        movapd nb101_dxH1(%rsp),%xmm0
        movapd nb101_dyH1(%rsp),%xmm1
        movapd nb101_dzH1(%rsp),%xmm2
        movlpd %xmm6,nb101_vctot(%rsp)
        mulsd  %xmm4,%xmm0
        mulsd  %xmm4,%xmm1
        mulsd  %xmm4,%xmm2

        ## update H1 forces 
        movapd nb101_fixH1(%rsp),%xmm3
        movapd nb101_fiyH1(%rsp),%xmm4
        movapd nb101_fizH1(%rsp),%xmm7
        addsd  %xmm0,%xmm3
        addsd  %xmm1,%xmm4
        addsd  %xmm2,%xmm7
        movlpd %xmm3,nb101_fixH1(%rsp)
        movlpd %xmm4,nb101_fiyH1(%rsp)
        movlpd %xmm7,nb101_fizH1(%rsp)
        ## update j forces with water H1 
        addsd  nb101_fjx(%rsp),%xmm0
        addsd  nb101_fjy(%rsp),%xmm1
        addsd  nb101_fjz(%rsp),%xmm2
        movsd %xmm0,nb101_fjx(%rsp)
        movsd %xmm1,nb101_fjy(%rsp)
        movsd %xmm2,nb101_fjz(%rsp)

        ## H2 interactions 
        movapd  %xmm5,%xmm4
        mulsd   %xmm4,%xmm4     ## xmm5=rinv, xmm4=rinvsq 
        mulsd  nb101_qqH(%rsp),%xmm5    ## xmm5=vcoul 
        mulsd  %xmm5,%xmm4              ## total fsH1 in xmm4 

        addsd  nb101_vctot(%rsp),%xmm5

        movapd nb101_dxH2(%rsp),%xmm0
        movapd nb101_dyH2(%rsp),%xmm1
        movapd nb101_dzH2(%rsp),%xmm2
        movlpd %xmm5,nb101_vctot(%rsp)
        mulsd  %xmm4,%xmm0
        mulsd  %xmm4,%xmm1
        mulsd  %xmm4,%xmm2

        ## update H2 forces 
        movapd nb101_fixH2(%rsp),%xmm3
        movapd nb101_fiyH2(%rsp),%xmm4
        movapd nb101_fizH2(%rsp),%xmm7
        addsd  %xmm0,%xmm3
        addsd  %xmm1,%xmm4
        addsd  %xmm2,%xmm7
        movlpd %xmm3,nb101_fixH2(%rsp)
        movlpd %xmm4,nb101_fiyH2(%rsp)
        movlpd %xmm7,nb101_fizH2(%rsp)
...
_nb_kernel101_x86_64_sse2.nb101_updateouterdata: 
        ...
        movapd nb101_fixO(%rsp),%xmm0
        movapd nb101_fiyO(%rsp),%xmm1
        movapd nb101_fizO(%rsp),%xmm2
        ...
        movapd nb101_fixH1(%rsp),%xmm0
        movapd nb101_fiyH1(%rsp),%xmm1
        movapd nb101_fizH1(%rsp),%xmm2
        ...
        movapd nb101_fixH2(%rsp),%xmm0
        movapd nb101_fiyH2(%rsp),%xmm1
        movapd nb101_fizH2(%rsp),%xmm2
        ...
        jmp _nb_kernel101_x86_64_sse2.nb101_outer
_nb_kernel101_x86_64_sse2.nb101_outerend: 
...
.set nb101nf_ninner, 344
        ...
        movsd (%rsi),%xmm0
        movsd %xmm0,nb101nf_facel(%rsp)

        ## create constant floating-point factors on stack
        movl $0x00000000,%eax   ## lower half of double half IEEE (hex)
        movl $0x3fe00000,%ebx
        movl %eax,nb101nf_half(%rsp)
        movl %ebx,nb101nf_half+4(%rsp)
        movsd nb101nf_half(%rsp),%xmm1
        shufpd $0,%xmm1,%xmm1  ## splat to all elements
        movapd %xmm1,%xmm3
        addpd  %xmm3,%xmm3      ## one
        movapd %xmm3,%xmm2
        addpd  %xmm2,%xmm2      ## two
        addpd  %xmm2,%xmm3      ## three
        movapd %xmm1,nb101nf_half(%rsp)
        movapd %xmm3,nb101nf_three(%rsp)
        ...
        movq nb101nf_p_facel(%rbp),%rsi
        movsd (%rsi),%xmm0
        movsd nb101nf_facel(%rsp),%xmm5
        mulsd  %xmm5,%xmm3
        mulsd  %xmm5,%xmm4

        shufpd $0,%xmm3,%xmm3
        shufpd $0,%xmm4,%xmm4
        movapd %xmm3,nb101nf_iqO(%rsp)
        movapd %xmm4,nb101nf_iqH(%rsp)

_nb_kernel101nf_x86_64_sse2.nb101nf_threadloop: 
        movq  nb101nf_count(%rbp),%rsi          ## pointer to sync counter
        movl  (%rsi),%eax
_nb_kernel101nf_x86_64_sse2.nb101nf_spinlock: 
        movl  %eax,%ebx                         ## ebx=*count=nn0
        addl  $1,%ebx                           ## ebx=nn1=nn0+10
        lock 
        cmpxchgl %ebx,(%rsi)                    ## write nn1 to *counter,
                                                ...
                                                ## or reread *counter to eax.
        pause                                   ## -> better p4 performance
        jnz _nb_kernel101nf_x86_64_sse2.nb101nf_spinlock
        ...
        subl %eax,%ebx                          ## calc number of outer lists
        movl %eax,%esi                          ## copy n to esi
        jg  _nb_kernel101nf_x86_64_sse2.nb101nf_outerstart
        jmp _nb_kernel101nf_x86_64_sse2.nb101nf_end

_nb_kernel101nf_x86_64_sse2.nb101nf_outerstart: 
        ## ebx contains number of outer iterations
        addl nb101nf_nouter(%rsp),%ebx
        movl %ebx,nb101nf_nouter(%rsp)

_nb_kernel101nf_x86_64_sse2.nb101nf_outer: 
        ...
        shufpd $0,%xmm4,%xmm4
        shufpd $0,%xmm5,%xmm5
        movapd %xmm3,nb101nf_ixO(%rsp)
        movapd %xmm4,nb101nf_iyO(%rsp)
        movapd %xmm5,nb101nf_izO(%rsp)
        ...
        shufpd $0,%xmm4,%xmm4
        shufpd $0,%xmm5,%xmm5
        movapd %xmm0,nb101nf_ixH1(%rsp)
        movapd %xmm1,nb101nf_iyH1(%rsp)
        movapd %xmm2,nb101nf_izH1(%rsp)
        movapd %xmm3,nb101nf_ixH2(%rsp)
        movapd %xmm4,nb101nf_iyH2(%rsp)
        movapd %xmm5,nb101nf_izH2(%rsp)

        ## clear vctot 
        xorpd %xmm4,%xmm4
        movapd %xmm4,nb101nf_vctot(%rsp)
        ...
        jge   _nb_kernel101nf_x86_64_sse2.nb101nf_unroll_loop
        jmp   _nb_kernel101nf_x86_64_sse2.nb101nf_checksingle
_nb_kernel101nf_x86_64_sse2.nb101nf_unroll_loop: 
        ## twice unrolled innerloop here 
        movq  nb101nf_innerjjnr(%rsp),%rdx       ## pointer to jjnr[k] 
        movl  (%rdx),%eax
        movl  4(%rdx),%ebx

        addq $8,nb101nf_innerjjnr(%rsp)             ## advance pointer (unrolled 2) 
        ...
        movlpd (%rsi,%rax,8),%xmm6      ## jq A 
        movhpd (%rsi,%rbx,8),%xmm6      ## jq B 
        movapd nb101nf_iqO(%rsp),%xmm3
        movapd nb101nf_iqH(%rsp),%xmm4
        mulpd %xmm6,%xmm3               ## qqO 
        mulpd %xmm6,%xmm4               ## qqH 

        movapd  %xmm3,nb101nf_qqO(%rsp)
        movapd  %xmm4,nb101nf_qqH(%rsp)
        ...
        movapd nb101nf_ixO(%rsp),%xmm4
        movapd nb101nf_iyO(%rsp),%xmm5
        movapd nb101nf_izO(%rsp),%xmm6
        ...
        movapd nb101nf_ixH1(%rsp),%xmm4
        movapd nb101nf_iyH1(%rsp),%xmm5
        movapd nb101nf_izH1(%rsp),%xmm6
        ...
        movapd nb101nf_ixH2(%rsp),%xmm3
        movapd nb101nf_iyH2(%rsp),%xmm4
        movapd nb101nf_izH2(%rsp),%xmm5
        ...
        mulpd %xmm3,%xmm4       ## lu*( 3-rsq*lu*lu) 
        mulpd nb101nf_half(%rsp),%xmm4   ## rinv 
        movapd  %xmm4,%xmm7     ## rinvO in xmm7 
        ...
        ## do O interactions 
        mulpd  nb101nf_qqO(%rsp),%xmm7          ## xmm7=vcoul 
        addpd  nb101nf_vctot(%rsp),%xmm7
        movapd %xmm7,nb101nf_vctot(%rsp)

        ## H1 interactions 
        mulpd  nb101nf_qqH(%rsp),%xmm6          ## xmm6=vcoul 
        addpd  nb101nf_vctot(%rsp),%xmm6
        movapd %xmm6,nb101nf_vctot(%rsp)

        ## H2 interactions 
        mulpd  nb101nf_qqH(%rsp),%xmm5          ## xmm5=vcoul 
        addpd  nb101nf_vctot(%rsp),%xmm5
        movapd %xmm5,nb101nf_vctot(%rsp)

        ## should we do one more iteration? 
        subl $2,nb101nf_innerk(%rsp)
        jl    _nb_kernel101nf_x86_64_sse2.nb101nf_checksingle
        jmp   _nb_kernel101nf_x86_64_sse2.nb101nf_unroll_loop
_nb_kernel101nf_x86_64_sse2.nb101nf_checksingle: 
        movl  nb101nf_innerk(%rsp),%edx
        andl  $1,%edx
        jnz   _nb_kernel101nf_x86_64_sse2.nb101nf_dosingle
        jmp   _nb_kernel101nf_x86_64_sse2.nb101nf_updateouterdata
_nb_kernel101nf_x86_64_sse2.nb101nf_dosingle: 
        movq  nb101nf_innerjjnr(%rsp),%rdx       ## pointer to jjnr[k] 
        movl  (%rdx),%eax
        ...
        subsd   %xmm2,%xmm4     ## 30-rsq*lu*lu 
        mulsd   %xmm3,%xmm4     ## lu*(3-rsq*lu*lu) 
        mulsd   nb101nf_half(%rsp),%xmm4   ## iter1 ( new lu) 
        ...
        subsd %xmm7,%xmm4       ## 3-rsq*lu*lu 
        mulsd %xmm3,%xmm4       ## lu*( 3-rsq*lu*lu) 
        mulsd nb101nf_half(%rsp),%xmm4   ## rinv 
        movapd  %xmm4,%xmm7     ## rinvO in xmm7 
        ...
        ## do O interactions 
        mulsd  nb101nf_qqO(%rsp),%xmm7          ## xmm7=vcoul 
        addsd  nb101nf_vctot(%rsp),%xmm7
        movlpd %xmm7,nb101nf_vctot(%rsp)

        ## H1 interactions 
        mulsd  nb101nf_qqH(%rsp),%xmm6          ## xmm6=vcoul 
        addsd  nb101nf_vctot(%rsp),%xmm6
        movlpd %xmm6,nb101nf_vctot(%rsp)

        ## H2 interactions 
        mulsd  nb101nf_qqH(%rsp),%xmm5          ## xmm5=vcoul 
        addsd  nb101nf_vctot(%rsp),%xmm5
        movlpd %xmm5,nb101nf_vctot(%rsp)

_nb_kernel101nf_x86_64_sse2.nb101nf_updateouterdata: 
        ## get n from stack
        ...
        jmp _nb_kernel101nf_x86_64_sse2.nb101nf_outer
_nb_kernel101nf_x86_64_sse2.nb101nf_outerend: 
        ## check if more outer neighborlists remain
        movl  nb101nf_nri(%rsp),%ecx
        ## esi already loaded with n above
        subl  %esi,%ecx
