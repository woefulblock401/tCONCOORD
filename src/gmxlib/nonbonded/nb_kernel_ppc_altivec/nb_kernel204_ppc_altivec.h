 ...
 *
 * $Id: nb_kernel204_ppc_altivec.h,v 1.1 2004/12/26 19:26:00 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL204_ALTIVEC_H_
#define _NB_KERNEL204_ALTIVEC_H_

/*! \file  nb_kernel204_ppc_altivec.h
 *  \brief Altivec-optimized versions of nonbonded kernel 204
 *
 *  \internal
 */
...
/*! \brief Nonbonded kernel 204 with forces, optimized for Altivec.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel204_ppc_altivec  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 204 without forces, optimized for Altivec.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Reaction-field <br>
 ...
 */
void
nb_kernel204nf_ppc_altivec(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL204_ALTIVEC_H_ */
