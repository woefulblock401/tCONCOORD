 ...
 *
 * $Id: nb_kernel204_ppc_altivec.c,v 1.1 2004/12/26 19:26:00 lindahl Exp $
 * 
...
void 
nb_kernel204_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	...
	vector float vctot,qqMM,qqMH,qqHH,qM,qH,vkrf,vcrf;
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				fs11            = vec_madd(fs11,qqHH,nul);
				fs12            = vec_madd(fs12,qqHH,nul);
				fs13            = vec_madd(fs13,qqMH,nul);
				fs21            = vec_madd(fs21,qqHH,nul);
				fs22            = vec_madd(fs22,qqHH,nul);
				fs23            = vec_madd(fs23,qqMH,nul);
				fs31            = vec_madd(fs31,qqMH,nul);
				fs32            = vec_madd(fs32,qqMH,nul);
				fs33            = vec_madd(fs33,qqMM,nul);
				...
				vctot           = vec_madd(qqHH,vc11,vctot);
				vctot           = vec_madd(qqHH,vc12,vctot);
				vctot           = vec_madd(qqMH,vc13,vctot);
				vctot           = vec_madd(qqHH,vc21,vctot);
				vctot           = vec_madd(qqHH,vc22,vctot);
				vctot           = vec_madd(qqMH,vc23,vctot);
				vctot           = vec_madd(qqMH,vc31,vctot);
				vctot           = vec_madd(qqMH,vc32,vctot);
				vctot           = vec_madd(qqMM,vc33,vctot);
			...
			if(k<(nj1-2)) {
				...
				fs11            = vec_madd(fs11,qqHHt,nul);
				fs12            = vec_madd(fs12,qqHHt,nul);
				fs13            = vec_madd(fs13,qqMHt,nul);
				fs21            = vec_madd(fs21,qqHHt,nul);
				fs22            = vec_madd(fs22,qqHHt,nul);
				fs23            = vec_madd(fs23,qqMHt,nul);
				fs31            = vec_madd(fs31,qqMHt,nul);
				fs32            = vec_madd(fs32,qqMHt,nul);
				fs33            = vec_madd(fs33,qqMMt,nul);
				...
				vctot           = vec_madd(qqHHt,vc11,vctot);
				vctot           = vec_madd(qqHHt,vc12,vctot);
				vctot           = vec_madd(qqMHt,vc13,vctot);
				vctot           = vec_madd(qqHHt,vc21,vctot);
				vctot           = vec_madd(qqHHt,vc22,vctot);
				vctot           = vec_madd(qqMHt,vc23,vctot);
				vctot           = vec_madd(qqMHt,vc31,vctot);
				vctot           = vec_madd(qqMHt,vc32,vctot);
				vctot           = vec_madd(qqMMt,vc33,vctot);
...
void 
nb_kernel204nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				vctot           = vec_madd(qqHH,rinv11,vctot);
				vctot           = vec_madd(qqHH,rinv12,vctot);
				vctot           = vec_madd(qqMH,rinv13,vctot);
				vctot           = vec_madd(qqHH,rinv21,vctot);
				vctot           = vec_madd(qqHH,rinv22,vctot);
				vctot           = vec_madd(qqMH,rinv23,vctot);
				vctot           = vec_madd(qqMH,rinv31,vctot);
				vctot           = vec_madd(qqMH,rinv32,vctot);
				vctot           = vec_madd(qqMM,rinv33,vctot);
			} 
			if(k<(nj1-2)) {
				jnra            = jjnr[k];
				jnrb            = jjnr[k+1];
