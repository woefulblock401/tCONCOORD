 ...
 *
 * $Id: nb_kernel314_ppc_altivec.c,v 1.1 2004/12/26 19:26:00 lindahl Exp $
 * 
...
void 
nb_kernel314_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	...
	vector float r22,r23,r24,r32,r33,r34,r42,r43,r44;
	vector float rinvsq11,rinv22,rinv23,rinv24,rinv32,rinv33;
	...
	vector float vctot,qqMM,qqMH,qqHH,qM,qH,c6,c12,Vvdw6,Vvdw12,rinvsix;
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				do_4_ctable_coul(VFtab,vec_madd(r24,tsc,nul),&VV24c,&FF24c);
				do_4_ctable_coul(VFtab,vec_madd(r32,tsc,nul),&VV32c,&FF32c);
				do_4_ctable_coul(VFtab,vec_madd(r33,tsc,nul),&VV33c,&FF33c);
				do_4_ctable_coul(VFtab,vec_madd(r34,tsc,nul),&VV34c,&FF34c);
				do_4_ctable_coul(VFtab,vec_madd(r42,tsc,nul),&VV42c,&FF42c);
				do_4_ctable_coul(VFtab,vec_madd(r43,tsc,nul),&VV43c,&FF43c);
				do_4_ctable_coul(VFtab,vec_madd(r44,tsc,nul),&VV44c,&FF44c);
			...
			if(k<(nj1-2)) {
				...
				do_3_ctable_coul(VFtab,vec_madd(r24,tsc,nul),&VV24c,&FF24c);
				do_3_ctable_coul(VFtab,vec_madd(r32,tsc,nul),&VV32c,&FF32c);
				do_3_ctable_coul(VFtab,vec_madd(r33,tsc,nul),&VV33c,&FF33c);
				do_3_ctable_coul(VFtab,vec_madd(r34,tsc,nul),&VV34c,&FF34c);
				do_3_ctable_coul(VFtab,vec_madd(r42,tsc,nul),&VV42c,&FF42c);
				do_3_ctable_coul(VFtab,vec_madd(r43,tsc,nul),&VV43c,&FF43c);
				do_3_ctable_coul(VFtab,vec_madd(r44,tsc,nul),&VV44c,&FF44c);
				...
				do_2_ctable_coul(VFtab,vec_madd(r24,tsc,nul),&VV24c,&FF24c);
				do_2_ctable_coul(VFtab,vec_madd(r32,tsc,nul),&VV32c,&FF32c);
				do_2_ctable_coul(VFtab,vec_madd(r33,tsc,nul),&VV33c,&FF33c);
				do_2_ctable_coul(VFtab,vec_madd(r34,tsc,nul),&VV34c,&FF34c);
				do_2_ctable_coul(VFtab,vec_madd(r42,tsc,nul),&VV42c,&FF42c);
				do_2_ctable_coul(VFtab,vec_madd(r43,tsc,nul),&VV43c,&FF43c);
				do_2_ctable_coul(VFtab,vec_madd(r44,tsc,nul),&VV44c,&FF44c);
				...
				do_1_ctable_coul(VFtab,vec_madd(r24,tsc,nul),&VV24c,&FF24c);
				do_1_ctable_coul(VFtab,vec_madd(r32,tsc,nul),&VV32c,&FF32c);
				do_1_ctable_coul(VFtab,vec_madd(r33,tsc,nul),&VV33c,&FF33c);
				do_1_ctable_coul(VFtab,vec_madd(r34,tsc,nul),&VV34c,&FF34c);
				do_1_ctable_coul(VFtab,vec_madd(r42,tsc,nul),&VV42c,&FF42c);
				do_1_ctable_coul(VFtab,vec_madd(r43,tsc,nul),&VV43c,&FF43c);
				do_1_ctable_coul(VFtab,vec_madd(r44,tsc,nul),&VV44c,&FF44c);
...
void 
nb_kernel314nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	...
	vector float vfacel,nul;
	vector float vctot,qqMM,qqMH,qqHH,qM,qH,c6,c12,rinvsix;
	vector float Vvdwtot,tsc,qqMMt,qqMHt,qqHHt,c6t,c12t;
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				do_vonly_4_ctable_coul(VFtab,vec_madd(r24,tsc,nul),&VV24c);
				do_vonly_4_ctable_coul(VFtab,vec_madd(r32,tsc,nul),&VV32c);
				do_vonly_4_ctable_coul(VFtab,vec_madd(r33,tsc,nul),&VV33c);
				do_vonly_4_ctable_coul(VFtab,vec_madd(r34,tsc,nul),&VV34c);
				do_vonly_4_ctable_coul(VFtab,vec_madd(r42,tsc,nul),&VV42c);
				do_vonly_4_ctable_coul(VFtab,vec_madd(r43,tsc,nul),&VV43c);
				do_vonly_4_ctable_coul(VFtab,vec_madd(r44,tsc,nul),&VV44c);
			...
			if(k<(nj1-2)) {
				...
				Vvdwtot          = vec_madd(c12t,vec_madd(rinvsix,rinvsix,nul),Vvdwtot);

				do_vonly_3_ctable_coul(VFtab,vec_madd(r22,tsc,nul),&VV22c);
				do_vonly_3_ctable_coul(VFtab,vec_madd(r23,tsc,nul),&VV23c);
				do_vonly_3_ctable_coul(VFtab,vec_madd(r24,tsc,nul),&VV24c);
				do_vonly_3_ctable_coul(VFtab,vec_madd(r32,tsc,nul),&VV32c);
				do_vonly_3_ctable_coul(VFtab,vec_madd(r33,tsc,nul),&VV33c);
				do_vonly_3_ctable_coul(VFtab,vec_madd(r34,tsc,nul),&VV34c);
				do_vonly_3_ctable_coul(VFtab,vec_madd(r42,tsc,nul),&VV42c);
				do_vonly_3_ctable_coul(VFtab,vec_madd(r43,tsc,nul),&VV43c);
				do_vonly_3_ctable_coul(VFtab,vec_madd(r44,tsc,nul),&VV44c);
				...
				do_vonly_2_ctable_coul(VFtab,vec_madd(r24,tsc,nul),&VV24c);
				do_vonly_2_ctable_coul(VFtab,vec_madd(r32,tsc,nul),&VV32c);
				do_vonly_2_ctable_coul(VFtab,vec_madd(r33,tsc,nul),&VV33c);
				do_vonly_2_ctable_coul(VFtab,vec_madd(r34,tsc,nul),&VV34c);
				do_vonly_2_ctable_coul(VFtab,vec_madd(r42,tsc,nul),&VV42c);
				do_vonly_2_ctable_coul(VFtab,vec_madd(r43,tsc,nul),&VV43c);
				do_vonly_2_ctable_coul(VFtab,vec_madd(r44,tsc,nul),&VV44c);
				...
				zero_highest_3_elements_in_9_vectors(&rsq22,&rsq23,&rsq24,
													 &rsq32,&rsq33,&rsq34,
													 &rsq42,&rsq43,&rsq44);
				...
				do_vonly_1_ctable_coul(VFtab,vec_madd(r24,tsc,nul),&VV24c);
				do_vonly_1_ctable_coul(VFtab,vec_madd(r32,tsc,nul),&VV32c);
				do_vonly_1_ctable_coul(VFtab,vec_madd(r33,tsc,nul),&VV33c);
				do_vonly_1_ctable_coul(VFtab,vec_madd(r34,tsc,nul),&VV34c);
				do_vonly_1_ctable_coul(VFtab,vec_madd(r42,tsc,nul),&VV42c);
				do_vonly_1_ctable_coul(VFtab,vec_madd(r43,tsc,nul),&VV43c);
				do_vonly_1_ctable_coul(VFtab,vec_madd(r44,tsc,nul),&VV44c);
