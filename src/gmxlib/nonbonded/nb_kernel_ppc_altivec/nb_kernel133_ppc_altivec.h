 ...
 *
 * $Id: nb_kernel133_ppc_altivec.h,v 1.1 2004/12/26 19:26:00 lindahl Exp $
 * 
 ...
 */
#ifndef _NB_KERNEL133_ALTIVEC_H_
#define _NB_KERNEL133_ALTIVEC_H_

/*! \file  nb_kernel133_ppc_altivec.h
 *  \brief Altivec-optimized versions of nonbonded kernel 133
 *
 *  \internal
 */


/*! \brief Nonbonded kernel 133 with forces, optimized for Altivec.
 *
 *  \internal
 *
 ...
 */
void
nb_kernel133_ppc_altivec  (int *   nri,        int     iinr[],   int     jindex[],
...
/*! \brief Nonbonded kernel 133 without forces, optimized for Altivec.
 *
 *  \internal
 *
 *  <b>Coulomb interaction:</b> Standard 1/r <br>
 ...
 */
void
nb_kernel133nf_ppc_altivec(int *   nri,        int     iinr[],   int     jindex[],
                       int     jjnr[],     int     shift[],  float   shiftvec[],
                       float   fshift[],   int     gid[],    float   pos[],
                       float   faction[],  float   charge[], float * facel,
                       float * krf,        float * crf,      float   Vc[],
...
#endif /* _NB_KERNEL133_ALTIVEC_H_ */
