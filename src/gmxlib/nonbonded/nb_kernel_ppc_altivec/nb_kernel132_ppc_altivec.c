 ...
 *
 * $Id: nb_kernel132_ppc_altivec.c,v 1.1 2004/12/26 19:26:00 lindahl Exp $
 * 
...
void 
nb_kernel132_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
					   ...
					   float *           work)
{
	...
	vector float rinv11,rinv12,rinv13,rinv21,rinv22;
	vector float rinv23,rinv31,rinv32,rinv33;
	...
	vector float Vvdwtot,c6,c12,c6t,c12t,VVd,VVr,FFd,FFr,tsc,r;
		...
		*count           = nn1;
		...
		for(n=0;n<nri;n++) {
			...
			for(k=nj0; k<(nj1-3); k+=4) {
				...
				fs11            = vec_madd(vc11,rinv11,fs11);
...
void 
nb_kernel132nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
...

{
	...
	vector float vfacel,nul;
	vector float vctot,qqOO,qqOH,qqHH,qO,qH,qqOOt,qqOHt,qqHHt;
	vector float Vvdwtot,c6,c12,c6t,c12t,VVd,VVr,tsc,r;
