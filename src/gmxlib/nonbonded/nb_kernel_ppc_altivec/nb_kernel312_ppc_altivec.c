 ...
 *
 * $Id: nb_kernel312_ppc_altivec.c,v 1.1 2004/12/26 19:26:00 lindahl Exp $
 * 
...
void 
nb_kernel312_ppc_altivec  (int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
...
void 
nb_kernel312nf_ppc_altivec(int *             p_nri,
                       int               iinr[],
                       int               jindex[],
                       int               jjnr[],
                       int               shift[],
