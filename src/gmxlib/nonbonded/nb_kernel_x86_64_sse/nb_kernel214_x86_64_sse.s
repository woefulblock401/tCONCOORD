##
## $Id: nb_kernel214_x86_64_sse.s,v 1.4.2.3 2006/09/22 08:32:50 lindahl Exp $
##
...
.set nb214_nri, 1824
.set nb214_iinr, 1832
.set nb214_jindex, 1840
.set nb214_jjnr, 1848
.set nb214_shift, 1856
.set nb214_shiftvec, 1864
.set nb214_facel, 1872
...
.set nb214_ninner, 1896
        ...
        shufps $0,%xmm1,%xmm1
        shufps $0,%xmm2,%xmm2
        movaps %xmm1,nb214_krf(%rsp)
        movaps %xmm2,nb214_crf(%rsp)

        ## create constant floating-point factors on stack
        movl $0x3f000000,%eax   ## half in IEEE (hex)
        movl %eax,nb214_half(%rsp)
        movss nb214_half(%rsp),%xmm1
        ...
        movaps %xmm1,nb214_half(%rsp)
        movaps %xmm2,nb214_two(%rsp)
        movaps %xmm3,nb214_three(%rsp)
        movaps %xmm4,nb214_six(%rsp)
        movaps %xmm5,nb214_twelve(%rsp)
        ...
        shufps $0,%xmm4,%xmm4
        shufps $0,%xmm5,%xmm5
        movaps %xmm3,nb214_qqMM(%rsp)
        movaps %xmm4,nb214_qqMH(%rsp)
        movaps %xmm5,nb214_qqHH(%rsp)
        ...
        movaps %xmm0,nb214_c6(%rsp)
        movaps %xmm1,nb214_c12(%rsp)

_nb_kernel214_x86_64_sse.nb214_threadloop: 
        movq  nb214_count(%rbp),%rsi            ## pointer to sync counter
        movl  (%rsi),%eax
_nb_kernel214_x86_64_sse.nb214_spinlock: 
        ...
        jnz _nb_kernel214_x86_64_sse.nb214_spinlock
        ...
        jg  _nb_kernel214_x86_64_sse.nb214_outerstart
        jmp _nb_kernel214_x86_64_sse.nb214_end

_nb_kernel214_x86_64_sse.nb214_outerstart: 
        ## ebx contains number of outer iterations
        addl nb214_nouter(%rsp),%ebx
        movl %ebx,nb214_nouter(%rsp)

_nb_kernel214_x86_64_sse.nb214_outer: 
        ...
        shufps $0,%xmm6,%xmm6
        shufps $0,%xmm7,%xmm7
        movaps %xmm3,nb214_ixO(%rsp)
        movaps %xmm4,nb214_iyO(%rsp)
        movaps %xmm5,nb214_izO(%rsp)
        movaps %xmm6,nb214_ixH1(%rsp)
        movaps %xmm7,nb214_iyH1(%rsp)
        ...
        shufps $0,%xmm4,%xmm4
        shufps $0,%xmm5,%xmm5
        movaps %xmm6,nb214_izH1(%rsp)
        movaps %xmm0,nb214_ixH2(%rsp)
        movaps %xmm1,nb214_iyH2(%rsp)
        movaps %xmm2,nb214_izH2(%rsp)
        movaps %xmm3,nb214_ixM(%rsp)
        movaps %xmm4,nb214_iyM(%rsp)
        movaps %xmm5,nb214_izM(%rsp)

        ## clear vctot and i forces 
        xorps %xmm4,%xmm4
        movaps %xmm4,nb214_vctot(%rsp)
        movaps %xmm4,nb214_Vvdwtot(%rsp)
        movaps %xmm4,nb214_fixO(%rsp)
        movaps %xmm4,nb214_fiyO(%rsp)
        movaps %xmm4,nb214_fizO(%rsp)
        movaps %xmm4,nb214_fixH1(%rsp)
        movaps %xmm4,nb214_fiyH1(%rsp)
        movaps %xmm4,nb214_fizH1(%rsp)
        movaps %xmm4,nb214_fixH2(%rsp)
        movaps %xmm4,nb214_fiyH2(%rsp)
        movaps %xmm4,nb214_fizH2(%rsp)
        movaps %xmm4,nb214_fixM(%rsp)
        movaps %xmm4,nb214_fiyM(%rsp)
        movaps %xmm4,nb214_fizM(%rsp)
        ...
        jge   _nb_kernel214_x86_64_sse.nb214_unroll_loop
        jmp   _nb_kernel214_x86_64_sse.nb214_single_check
_nb_kernel214_x86_64_sse.nb214_unroll_loop: 
        ...
        addq $16,nb214_innerjjnr(%rsp)             ## advance pointer (unroll 4) 
    ...
    subps nb214_ixO(%rsp),%xmm0
    subps nb214_iyO(%rsp),%xmm1
    subps nb214_izO(%rsp),%xmm2
    ...
    movss  8(%rdi,%rbx,4),%xmm0     ## jzb
    movss  8(%rdi,%rdx,4),%xmm8     ## jzd
    movlhps %xmm0,%xmm12 ## jza  -  jzb  -
    movlhps %xmm8,%xmm13 ## jzc  -  jzd -
    ...
    ## calc rinvsq=1/rsq
        ...
        mulps  nb214_c6(%rsp),%xmm0
        mulps  nb214_c12(%rsp),%xmm2
        movaps %xmm2,%xmm8
    subps  %xmm0,%xmm2  ## Vvdw=Vvdw12-Vvdw6 
        mulps  nb214_six(%rsp),%xmm0
        mulps  nb214_twelve(%rsp),%xmm8
        subps  %xmm0,%xmm8
        mulps  %xmm1,%xmm8      ## xmm8=total fscal 

    ## add potential to Vvdwtot
        addps  nb214_Vvdwtot(%rsp),%xmm2
    movaps %xmm2,nb214_Vvdwtot(%rsp)
    ...
    ## increment i force
    movaps nb214_fixO(%rsp),%xmm0
    movaps nb214_fiyO(%rsp),%xmm1
    movaps nb214_fizO(%rsp),%xmm2
    addps  %xmm4,%xmm0
    addps  %xmm5,%xmm1
    addps  %xmm6,%xmm2
    movaps %xmm0,nb214_fixO(%rsp)
    movaps %xmm1,nb214_fiyO(%rsp)
    movaps %xmm2,nb214_fizO(%rsp)
    ...
    subps nb214_ixH1(%rsp),%xmm0
    subps nb214_iyH1(%rsp),%xmm1
    subps nb214_izH1(%rsp),%xmm2
    subps nb214_ixH2(%rsp),%xmm3
    subps nb214_iyH2(%rsp),%xmm4
    subps nb214_izH2(%rsp),%xmm5
    subps nb214_ixM(%rsp),%xmm6
    subps nb214_iyM(%rsp),%xmm7
    subps nb214_izM(%rsp),%xmm8

        movaps %xmm0,nb214_dxH1H1(%rsp)
        movaps %xmm1,nb214_dyH1H1(%rsp)
        movaps %xmm2,nb214_dzH1H1(%rsp)
        mulps  %xmm0,%xmm0
        mulps  %xmm1,%xmm1
        mulps  %xmm2,%xmm2
        movaps %xmm3,nb214_dxH2H1(%rsp)
        movaps %xmm4,nb214_dyH2H1(%rsp)
        movaps %xmm5,nb214_dzH2H1(%rsp)
        mulps  %xmm3,%xmm3
        mulps  %xmm4,%xmm4
        mulps  %xmm5,%xmm5
        movaps %xmm6,nb214_dxMH1(%rsp)
        movaps %xmm7,nb214_dyMH1(%rsp)
        movaps %xmm8,nb214_dzMH1(%rsp)
        mulps  %xmm6,%xmm6
        mulps  %xmm7,%xmm7
        mulps  %xmm8,%xmm8
        addps  %xmm1,%xmm0
    ...
    addps  %xmm4,%xmm5
    addps  %xmm7,%xmm8
    movaps nb214_crf(%rsp),%xmm14
    subps  %xmm14,%xmm2  ## rinv+krsq-crf
    subps  %xmm14,%xmm5
    subps  %xmm14,%xmm8
    movaps nb214_qqHH(%rsp),%xmm12
    movaps nb214_qqMH(%rsp),%xmm13
    ...
    movaps %xmm7,%xmm8
        ...
        mulps nb214_dxH1H1(%rsp),%xmm0
        mulps nb214_dyH1H1(%rsp),%xmm1
        mulps nb214_dzH1H1(%rsp),%xmm2
        mulps nb214_dxH2H1(%rsp),%xmm3
        mulps nb214_dyH2H1(%rsp),%xmm4
        mulps nb214_dzH2H1(%rsp),%xmm5
        mulps nb214_dxMH1(%rsp),%xmm6
        mulps nb214_dyMH1(%rsp),%xmm7
        mulps nb214_dzMH1(%rsp),%xmm8

    movaps %xmm0,%xmm13
    movaps %xmm1,%xmm14
    addps %xmm2,%xmm11
    addps nb214_fixH1(%rsp),%xmm0
    addps nb214_fiyH1(%rsp),%xmm1
    addps nb214_fizH1(%rsp),%xmm2

    addps %xmm3,%xmm13
    addps %xmm4,%xmm14
    addps %xmm5,%xmm11
    addps nb214_fixH2(%rsp),%xmm3
    addps nb214_fiyH2(%rsp),%xmm4
    addps nb214_fizH2(%rsp),%xmm5

    addps %xmm6,%xmm13
    addps %xmm7,%xmm14
    addps %xmm8,%xmm11
    addps nb214_fixM(%rsp),%xmm6
    addps nb214_fiyM(%rsp),%xmm7
    addps nb214_fizM(%rsp),%xmm8

    movaps %xmm0,nb214_fixH1(%rsp)
    movaps %xmm1,nb214_fiyH1(%rsp)
    movaps %xmm2,nb214_fizH1(%rsp)
    movaps %xmm3,nb214_fixH2(%rsp)
    movaps %xmm4,nb214_fiyH2(%rsp)
    movaps %xmm5,nb214_fizH2(%rsp)
    movaps %xmm6,nb214_fixM(%rsp)
    movaps %xmm7,nb214_fiyM(%rsp)
    movaps %xmm8,nb214_fizM(%rsp)
    ...
    subps nb214_izM(%rsp),%xmm8
        ...
        movaps %xmm0,nb214_dxH1H2(%rsp)
        movaps %xmm1,nb214_dyH1H2(%rsp)
        movaps %xmm2,nb214_dzH1H2(%rsp)
        mulps  %xmm0,%xmm0
        mulps  %xmm1,%xmm1
        mulps  %xmm2,%xmm2
        movaps %xmm3,nb214_dxH2H2(%rsp)
        movaps %xmm4,nb214_dyH2H2(%rsp)
        movaps %xmm5,nb214_dzH2H2(%rsp)
        mulps  %xmm3,%xmm3
        mulps  %xmm4,%xmm4
        mulps  %xmm5,%xmm5
        movaps %xmm6,nb214_dxMH2(%rsp)
        movaps %xmm7,nb214_dyMH2(%rsp)
        movaps %xmm8,nb214_dzMH2(%rsp)
        mulps  %xmm6,%xmm6
        mulps  %xmm7,%xmm7
        mulps  %xmm8,%xmm8
        addps  %xmm1,%xmm0
    ...
    movaps %xmm7,%xmm8
        ...
        mulps nb214_dxH1H2(%rsp),%xmm0
        mulps nb214_dyH1H2(%rsp),%xmm1
        mulps nb214_dzH1H2(%rsp),%xmm2
        mulps nb214_dxH2H2(%rsp),%xmm3
        mulps nb214_dyH2H2(%rsp),%xmm4
        mulps nb214_dzH2H2(%rsp),%xmm5
        mulps nb214_dxMH2(%rsp),%xmm6
        mulps nb214_dyMH2(%rsp),%xmm7
        mulps nb214_dzMH2(%rsp),%xmm8
    ...
    subps nb214_izM(%rsp),%xmm8
        ...
        movaps %xmm0,nb214_dxH1M(%rsp)
        movaps %xmm1,nb214_dyH1M(%rsp)
        movaps %xmm2,nb214_dzH1M(%rsp)
        mulps  %xmm0,%xmm0
        mulps  %xmm1,%xmm1
        mulps  %xmm2,%xmm2
        movaps %xmm3,nb214_dxH2M(%rsp)
        movaps %xmm4,nb214_dyH2M(%rsp)
        movaps %xmm5,nb214_dzH2M(%rsp)
        mulps  %xmm3,%xmm3
        mulps  %xmm4,%xmm4
        mulps  %xmm5,%xmm5
        movaps %xmm6,nb214_dxMM(%rsp)
        movaps %xmm7,nb214_dyMM(%rsp)
        movaps %xmm8,nb214_dzMM(%rsp)
        mulps  %xmm6,%xmm6
        mulps  %xmm7,%xmm7
        mulps  %xmm8,%xmm8
        addps  %xmm1,%xmm0
    ...
    subps  %xmm14,%xmm5
    subps  %xmm14,%xmm8
    movaps nb214_qqMH(%rsp),%xmm12
    movaps nb214_qqMM(%rsp),%xmm13
    mulps  %xmm12,%xmm2 ## xmm6=voul=qq*(rinv+ krsq-crf)
    mulps  %xmm12,%xmm5 ## xmm6=voul=qq*(rinv+ krsq-crf)
    mulps  %xmm13,%xmm8 ## xmm6=voul=qq*(rinv+ krsq-crf)
    addps  %xmm0,%xmm0 ## 2*krsq
    ...
    movaps %xmm7,%xmm8
        ...
        mulps nb214_dxH1M(%rsp),%xmm0
        mulps nb214_dyH1M(%rsp),%xmm1
        mulps nb214_dzH1M(%rsp),%xmm2
        mulps nb214_dxH2M(%rsp),%xmm3
        mulps nb214_dyH2M(%rsp),%xmm4
        mulps nb214_dzH2M(%rsp),%xmm5
        mulps nb214_dxMM(%rsp),%xmm6
        mulps nb214_dyMM(%rsp),%xmm7
        mulps nb214_dzMM(%rsp),%xmm8
    ...
    movss  %xmm12,44(%rdi,%rdx,4)
        ...
        subl $4,nb214_innerk(%rsp)
        jl    _nb_kernel214_x86_64_sse.nb214_single_check
        jmp   _nb_kernel214_x86_64_sse.nb214_unroll_loop
_nb_kernel214_x86_64_sse.nb214_single_check: 
        addl $4,nb214_innerk(%rsp)
        jnz   _nb_kernel214_x86_64_sse.nb214_single_loop
        jmp   _nb_kernel214_x86_64_sse.nb214_updateouterdata
_nb_kernel214_x86_64_sse.nb214_single_loop: 
        movq  nb214_innerjjnr(%rsp),%rdx        ## pointer to jjnr[k] 
        movl  (%rdx),%eax
        addq $4,nb214_innerjjnr(%rsp)
        ...
        movaps %xmm6,nb214_jxO(%rsp)
        movaps %xmm3,nb214_jyO(%rsp)
        movaps %xmm1,nb214_jzO(%rsp)
    ...
    movaps %xmm2,%xmm5  ## jzO
        ...
        subps  nb214_iyO(%rsp),%xmm1
        subps  nb214_izO(%rsp),%xmm2
        subps  nb214_ixM(%rsp),%xmm3
        subps  nb214_iyM(%rsp),%xmm4
        subps  nb214_izM(%rsp),%xmm5

        movaps %xmm0,nb214_dxOO(%rsp)
        movaps %xmm1,nb214_dyOO(%rsp)
        movaps %xmm2,nb214_dzOO(%rsp)
        movaps %xmm3,nb214_dxMM(%rsp)
        movaps %xmm4,nb214_dyMM(%rsp)
        movaps %xmm5,nb214_dzMM(%rsp)
        ...
        ## Save M data 
        movaps %xmm4,nb214_rsqMM(%rsp)

        ## do 1/x for O and 1/sqrt(x) for M
        rcpss  %xmm0,%xmm1
        rsqrtps %xmm4,%xmm5
        movss  nb214_two(%rsp),%xmm2
        movaps  %xmm5,%xmm6
        mulss  %xmm1,%xmm0
        mulps   %xmm5,%xmm5
        subss  %xmm0,%xmm2
        movaps  nb214_three(%rsp),%xmm7
        ...
        mulps   nb214_half(%rsp),%xmm7   ## rinv iH1 - j water 
        movss  %xmm2,%xmm1
        movaps %xmm7,nb214_rinvMM(%rsp)

        mulss  %xmm2,%xmm2      ## 1/r12
        mulss  nb214_c6(%rsp),%xmm1
        mulss  nb214_c12(%rsp),%xmm2
        movss  %xmm2,%xmm3
        subss  %xmm1,%xmm3
        addss  nb214_Vvdwtot(%rsp),%xmm3
        movss  %xmm3,nb214_Vvdwtot(%rsp)
        mulss  nb214_six(%rsp),%xmm1
        mulss  nb214_twelve(%rsp),%xmm2
        subss  %xmm1,%xmm2
        mulss  %xmm2,%xmm0      ## fscal
        movss  %xmm0,%xmm1
        movss  %xmm0,%xmm2
        mulss  nb214_dxOO(%rsp),%xmm0
        mulss  nb214_dyOO(%rsp),%xmm1
        mulss  nb214_dzOO(%rsp),%xmm2
        xorps   %xmm3,%xmm3
        xorps   %xmm4,%xmm4
        xorps   %xmm5,%xmm5
        addss   %xmm0,%xmm3
        addss   %xmm1,%xmm4
        addss   %xmm2,%xmm5
        movaps  %xmm3,nb214_fjxO(%rsp)
        movaps  %xmm4,nb214_fjyO(%rsp)
        movaps  %xmm5,nb214_fjzO(%rsp)
        addss   nb214_fixO(%rsp),%xmm0
        addss   nb214_fiyO(%rsp),%xmm1
        addss   nb214_fizO(%rsp),%xmm2
        movss  %xmm0,nb214_fixO(%rsp)
        movss  %xmm1,nb214_fiyO(%rsp)
        movss  %xmm2,nb214_fizO(%rsp)

        ## do  M coulomb interaction
        movaps nb214_rinvMM(%rsp),%xmm0
        movaps %xmm0,%xmm7      ## xmm7=rinv 
        movaps nb214_krf(%rsp),%xmm5
        mulps  %xmm0,%xmm0      ## xmm0=rinvsq 

        ## fetch charges to xmm3 (temporary) 
        xorps  %xmm3,%xmm3
        movss   nb214_qqMH(%rsp),%xmm3
        movhps  nb214_qqMM(%rsp),%xmm3
        shufps $193,%xmm3,%xmm3 ## 11000001 

        mulps  nb214_rsqMM(%rsp),%xmm5   ## xmm5=krsq 
        movaps %xmm5,%xmm6
        addps  %xmm7,%xmm6      ## xmm6=rinv+ krsq 
        subps  nb214_crf(%rsp),%xmm6
        mulps  %xmm3,%xmm6 ## xmm6=voul=qq*(rinv+ krsq-crf) 
        mulps nb214_two(%rsp),%xmm5
        subps  %xmm5,%xmm7      ## xmm7=rinv-2*krsq 
        mulps  %xmm3,%xmm7 ## xmm7 = coul part of fscal 

        addps  nb214_vctot(%rsp),%xmm6
        movaps %xmm6,nb214_vctot(%rsp)
        mulps  %xmm7,%xmm0

        movaps %xmm0,%xmm1
        movaps %xmm0,%xmm2

        mulps   nb214_dxMM(%rsp),%xmm0
        mulps   nb214_dyMM(%rsp),%xmm1
        mulps   nb214_dzMM(%rsp),%xmm2
        ## update forces M - j water 
        movaps  nb214_fjxO(%rsp),%xmm3
        movaps  nb214_fjyO(%rsp),%xmm4
        movaps  nb214_fjzO(%rsp),%xmm5
        addps   %xmm0,%xmm3
        addps   %xmm1,%xmm4
        addps   %xmm2,%xmm5
        movaps  %xmm3,nb214_fjxO(%rsp)
        movaps  %xmm4,nb214_fjyO(%rsp)
        movaps  %xmm5,nb214_fjzO(%rsp)
        addps   nb214_fixM(%rsp),%xmm0
        addps   nb214_fiyM(%rsp),%xmm1
        addps   nb214_fizM(%rsp),%xmm2
        movaps  %xmm0,nb214_fixM(%rsp)
        movaps  %xmm1,nb214_fiyM(%rsp)
        movaps  %xmm2,nb214_fizM(%rsp)

        ## i H1 & H2 simultaneously first get i particle coords: 
    movaps  nb214_jxO(%rsp),%xmm0
    movaps  nb214_jyO(%rsp),%xmm1
    movaps  nb214_jzO(%rsp),%xmm2
    movaps  %xmm0,%xmm3
    movaps  %xmm1,%xmm4
    movaps  %xmm2,%xmm5
        subps   nb214_ixH1(%rsp),%xmm0
        ...
        movaps  %xmm0,nb214_rsqH1H1(%rsp)
        movaps  %xmm4,nb214_rsqH2H2(%rsp)
        ...
        mulps   %xmm2,%xmm3
        mulps   %xmm6,%xmm7
        mulps   nb214_half(%rsp),%xmm3   ## rinvH1H1
        mulps   nb214_half(%rsp),%xmm7   ## rinvH2H2
        movaps  %xmm3,nb214_rinvH1H1(%rsp)
        movaps  %xmm7,nb214_rinvH2H2(%rsp)

        ## Do H1 coulomb interaction
        movaps nb214_rinvH1H1(%rsp),%xmm0
        movaps %xmm0,%xmm7      ## xmm7=rinv 
        movaps nb214_krf(%rsp),%xmm5
        mulps  %xmm0,%xmm0      ## xmm0=rinvsq 
        ...
        ## fetch charges to xmm3 (temporary) 
        xorps  %xmm3,%xmm3
        movss   nb214_qqHH(%rsp),%xmm3
        movhps  nb214_qqMH(%rsp),%xmm3
        shufps $193,%xmm3,%xmm3 ## 11000001 

        mulps  nb214_rsqH1H1(%rsp),%xmm5   ## xmm5=krsq 
        movaps %xmm5,%xmm6
        addps  %xmm7,%xmm6      ## xmm6=rinv+ krsq 
        subps  nb214_crf(%rsp),%xmm6
        mulps  %xmm3,%xmm6 ## xmm6=voul=qq*(rinv+ krsq-crf) 
        ...
        ## H2 Coulomb
        movaps nb214_rinvH2H2(%rsp),%xmm0
        movaps %xmm0,%xmm7      ## xmm7=rinv 
        movaps nb214_krf(%rsp),%xmm5
        mulps  %xmm0,%xmm0      ## xmm0=rinvsq 
        ...
        mulps  nb214_rsqH2H2(%rsp),%xmm5   ## xmm5=krsq 
        movaps %xmm5,%xmm6
        addps  %xmm7,%xmm6      ## xmm6=rinv+ krsq 
        subps  nb214_crf(%rsp),%xmm6
        mulps  %xmm3,%xmm6 ## xmm6=voul=qq*(rinv+ krsq-crf) 
        ...
        addps  nb214_vctot(%rsp),%xmm6   ## local vctot summation variable
        movaps %xmm6,nb214_vctot(%rsp)
        mulps  %xmm7,%xmm0
        ...
        mulps   nb214_dxH2H2(%rsp),%xmm0
        mulps   nb214_dyH2H2(%rsp),%xmm1
        mulps   nb214_dzH2H2(%rsp),%xmm2
        ...
        movaps  %xmm4,nb214_fjyO(%rsp)
        movaps  %xmm5,nb214_fjzO(%rsp)
        addps   nb214_fixH2(%rsp),%xmm0
        addps   nb214_fiyH2(%rsp),%xmm1
        addps   nb214_fizH2(%rsp),%xmm2
        movaps  %xmm0,nb214_fixH2(%rsp)
        movaps  %xmm1,nb214_fiyH2(%rsp)
        movaps  %xmm2,nb214_fizH2(%rsp)

        movq    nb214_faction(%rbp),%rsi
        ## update j water forces from local variables.
        ## transpose back first
        movaps  nb214_fjxO(%rsp),%xmm0   ## Ox H1x H2x Mx 
        movaps  nb214_fjyO(%rsp),%xmm1   ## Oy H1y H2y My
        movaps  nb214_fjzO(%rsp),%xmm2   ## Oz H1z H2z Mz
        ...
        decl nb214_innerk(%rsp)
        jz    _nb_kernel214_x86_64_sse.nb214_updateouterdata
        jmp   _nb_kernel214_x86_64_sse.nb214_single_loop
_nb_kernel214_x86_64_sse.nb214_updateouterdata: 
        ...
        movaps nb214_fixH1(%rsp),%xmm0
        movaps nb214_fiyH1(%rsp),%xmm1
        movaps nb214_fizH1(%rsp),%xmm2
        ...
        movaps nb214_fixH2(%rsp),%xmm0
        movaps nb214_fiyH2(%rsp),%xmm1
        movaps nb214_fizH2(%rsp),%xmm2
        ...
        movaps nb214_fixM(%rsp),%xmm0
        movaps nb214_fiyM(%rsp),%xmm1
        movaps nb214_fizM(%rsp),%xmm2
        ...
        incl %esi
        subl %esi,%ecx
        jz _nb_kernel214_x86_64_sse.nb214_outerend

        ## not last, iterate outer loop once more!  
        movl %esi,nb214_n(%rsp)
        jmp _nb_kernel214_x86_64_sse.nb214_outer
_nb_kernel214_x86_64_sse.nb214_outerend: 
        ## check if more outer neighborlists remain
        movl  nb214_nri(%rsp),%ecx
        ## esi already loaded with n above
        subl  %esi,%ecx
        jz _nb_kernel214_x86_64_sse.nb214_end
        ## non-zero, do one more workunit
        jmp   _nb_kernel214_x86_64_sse.nb214_threadloop
_nb_kernel214_x86_64_sse.nb214_end: 
...
.set nb214nf_nri, 912
.set nb214nf_iinr, 920
.set nb214nf_jindex, 928
.set nb214nf_jjnr, 936
.set nb214nf_shift, 944
.set nb214nf_shiftvec, 952
.set nb214nf_facel, 960
...
.set nb214nf_ninner, 984
        ...
        shufps $0,%xmm1,%xmm1
        shufps $0,%xmm2,%xmm2
        movaps %xmm1,nb214nf_krf(%rsp)
        movaps %xmm2,nb214nf_crf(%rsp)

        ## create constant floating-point factors on stack
        movl $0x3f000000,%eax   ## half in IEEE (hex)
        movl %eax,nb214nf_half(%rsp)
        movss nb214nf_half(%rsp),%xmm1
        shufps $0,%xmm1,%xmm1  ## splat to all elements
        movaps %xmm1,%xmm2
        addps  %xmm2,%xmm2      ## one
        movaps %xmm2,%xmm3
        addps  %xmm2,%xmm2      ## two
        addps  %xmm2,%xmm3      ## three
        movaps %xmm1,nb214nf_half(%rsp)
        movaps %xmm2,nb214nf_two(%rsp)
        movaps %xmm3,nb214nf_three(%rsp)
        ...
        shufps $0,%xmm4,%xmm4
        shufps $0,%xmm5,%xmm5
        movaps %xmm3,nb214nf_qqMM(%rsp)
        movaps %xmm4,nb214nf_qqMH(%rsp)
        movaps %xmm5,nb214nf_qqHH(%rsp)
        ...
        shufps $0,%xmm0,%xmm0
        shufps $0x55,%xmm1,%xmm1
        movaps %xmm0,nb214nf_c6(%rsp)
        movaps %xmm1,nb214nf_c12(%rsp)

_nb_kernel214nf_x86_64_sse.nb214nf_threadloop: 
        movq  nb214nf_count(%rbp),%rsi            ## pointer to sync counter
        movl  (%rsi),%eax
_nb_kernel214nf_x86_64_sse.nb214nf_spinlock: 
        movl  %eax,%ebx                         ## ebx=*count=nn0
        addq  $1,%rbx                          ## rbx=nn1=nn0+10
        lock 
        cmpxchgl %ebx,(%rsi)                    ## write nn1 to *counter,
                                                ...
                                                ## or reread *counter to eax.
        pause                                   ## -> better p4 performance
        jnz _nb_kernel214nf_x86_64_sse.nb214nf_spinlock
        ...
        subl %eax,%ebx                          ## calc number of outer lists
        movl %eax,%esi                          ## copy n to esi
        jg  _nb_kernel214nf_x86_64_sse.nb214nf_outerstart
        jmp _nb_kernel214nf_x86_64_sse.nb214nf_end

_nb_kernel214nf_x86_64_sse.nb214nf_outerstart: 
        ## ebx contains number of outer iterations
        addl nb214nf_nouter(%rsp),%ebx
        movl %ebx,nb214nf_nouter(%rsp)

_nb_kernel214nf_x86_64_sse.nb214nf_outer: 
        ...
        shufps $0,%xmm6,%xmm6
        shufps $0,%xmm7,%xmm7
        movaps %xmm3,nb214nf_ixO(%rsp)
        movaps %xmm4,nb214nf_iyO(%rsp)
        movaps %xmm5,nb214nf_izO(%rsp)
        movaps %xmm6,nb214nf_ixH1(%rsp)
        movaps %xmm7,nb214nf_iyH1(%rsp)
        ...
        shufps $0,%xmm4,%xmm4
        shufps $0,%xmm5,%xmm5
        movaps %xmm6,nb214nf_izH1(%rsp)
        movaps %xmm0,nb214nf_ixH2(%rsp)
        movaps %xmm1,nb214nf_iyH2(%rsp)
        movaps %xmm2,nb214nf_izH2(%rsp)
        movaps %xmm3,nb214nf_ixM(%rsp)
        movaps %xmm4,nb214nf_iyM(%rsp)
        movaps %xmm5,nb214nf_izM(%rsp)

        ## clear vctot 
        xorps %xmm4,%xmm4
        movaps %xmm4,nb214nf_vctot(%rsp)
        movaps %xmm4,nb214nf_Vvdwtot(%rsp)
        ...
        jge   _nb_kernel214nf_x86_64_sse.nb214nf_unroll_loop
        jmp   _nb_kernel214nf_x86_64_sse.nb214nf_single_check
_nb_kernel214nf_x86_64_sse.nb214nf_unroll_loop: 
        ## quad-unroll innerloop here 
        ...
        addq $16,nb214nf_innerjjnr(%rsp)             ## advance pointer (unroll 4) 
        ...
        ## store
        movaps %xmm0,nb214nf_jxO(%rsp)
        movaps %xmm1,nb214nf_jyO(%rsp)
        movaps %xmm2,nb214nf_jzO(%rsp)
        movaps %xmm3,nb214nf_jxH1(%rsp)
        ...
        ## coordinates in xmm0-xmm3     
        ## store
        movaps %xmm0,nb214nf_jyH1(%rsp)
        movaps %xmm1,nb214nf_jzH1(%rsp)
        movaps %xmm2,nb214nf_jxH2(%rsp)
        movaps %xmm3,nb214nf_jyH2(%rsp)
        ...
        ## coordinates in xmm0-xmm3     
        ## store
        movaps %xmm0,nb214nf_jzH2(%rsp)
        movaps %xmm1,nb214nf_jxM(%rsp)
        movaps %xmm2,nb214nf_jyM(%rsp)
        movaps %xmm3,nb214nf_jzM(%rsp)

        ## start calculating pairwise distances
        movaps nb214nf_ixO(%rsp),%xmm0
        movaps nb214nf_iyO(%rsp),%xmm1
        movaps nb214nf_izO(%rsp),%xmm2
        movaps nb214nf_ixH1(%rsp),%xmm3
        movaps nb214nf_iyH1(%rsp),%xmm4
        movaps nb214nf_izH1(%rsp),%xmm5
        subps  nb214nf_jxO(%rsp),%xmm0
        subps  nb214nf_jyO(%rsp),%xmm1
        subps  nb214nf_jzO(%rsp),%xmm2
        subps  nb214nf_jxH1(%rsp),%xmm3
        subps  nb214nf_jyH1(%rsp),%xmm4
        subps  nb214nf_jzH1(%rsp),%xmm5
        mulps  %xmm0,%xmm0
        mulps  %xmm1,%xmm1
        mulps  %xmm2,%xmm2
        mulps  %xmm3,%xmm3
        ...
        addps  %xmm4,%xmm3
        addps  %xmm5,%xmm3
        movaps %xmm0,nb214nf_rsqOO(%rsp)
        movaps %xmm3,nb214nf_rsqH1H1(%rsp)

        movaps nb214nf_ixH1(%rsp),%xmm0
        movaps nb214nf_iyH1(%rsp),%xmm1
        movaps nb214nf_izH1(%rsp),%xmm2
        movaps %xmm0,%xmm3
        movaps %xmm1,%xmm4
        movaps %xmm2,%xmm5
        subps  nb214nf_jxH2(%rsp),%xmm0
        subps  nb214nf_jyH2(%rsp),%xmm1
        subps  nb214nf_jzH2(%rsp),%xmm2
        subps  nb214nf_jxM(%rsp),%xmm3
        subps  nb214nf_jyM(%rsp),%xmm4
        subps  nb214nf_jzM(%rsp),%xmm5
        mulps  %xmm0,%xmm0
        mulps  %xmm1,%xmm1
        mulps  %xmm2,%xmm2
        mulps  %xmm3,%xmm3
        ...
        addps  %xmm4,%xmm3
        addps  %xmm5,%xmm3
        movaps %xmm0,nb214nf_rsqH1H2(%rsp)
        movaps %xmm3,nb214nf_rsqH1M(%rsp)

        movaps nb214nf_ixH2(%rsp),%xmm0
        movaps nb214nf_iyH2(%rsp),%xmm1
        movaps nb214nf_izH2(%rsp),%xmm2
        movaps %xmm0,%xmm3
        movaps %xmm1,%xmm4
        movaps %xmm2,%xmm5
        subps  nb214nf_jxH1(%rsp),%xmm0
        subps  nb214nf_jyH1(%rsp),%xmm1
        subps  nb214nf_jzH1(%rsp),%xmm2
        subps  nb214nf_jxH2(%rsp),%xmm3
        subps  nb214nf_jyH2(%rsp),%xmm4
        subps  nb214nf_jzH2(%rsp),%xmm5
        mulps  %xmm0,%xmm0
        mulps  %xmm1,%xmm1
        mulps  %xmm2,%xmm2
        mulps  %xmm3,%xmm3
        ...
        addps  %xmm4,%xmm3
        addps  %xmm5,%xmm3
        movaps %xmm0,nb214nf_rsqH2H1(%rsp)
        movaps %xmm3,nb214nf_rsqH2H2(%rsp)

        movaps nb214nf_ixH2(%rsp),%xmm0
        movaps nb214nf_iyH2(%rsp),%xmm1
        movaps nb214nf_izH2(%rsp),%xmm2
        movaps nb214nf_ixM(%rsp),%xmm3
        movaps nb214nf_iyM(%rsp),%xmm4
        movaps nb214nf_izM(%rsp),%xmm5
        subps  nb214nf_jxM(%rsp),%xmm0
        subps  nb214nf_jyM(%rsp),%xmm1
        subps  nb214nf_jzM(%rsp),%xmm2
        subps  nb214nf_jxH1(%rsp),%xmm3
        subps  nb214nf_jyH1(%rsp),%xmm4
        subps  nb214nf_jzH1(%rsp),%xmm5
        mulps  %xmm0,%xmm0
        ...
        addps  %xmm3,%xmm4
        addps  %xmm5,%xmm4
        movaps %xmm0,nb214nf_rsqH2M(%rsp)
        movaps %xmm4,nb214nf_rsqMH1(%rsp)

        movaps nb214nf_ixM(%rsp),%xmm0
        movaps nb214nf_iyM(%rsp),%xmm1
        movaps nb214nf_izM(%rsp),%xmm2
        movaps %xmm0,%xmm3
        movaps %xmm1,%xmm4
        movaps %xmm2,%xmm5
        subps  nb214nf_jxH2(%rsp),%xmm0
        ...
        addps  %xmm3,%xmm4
        addps  %xmm5,%xmm4
        movaps %xmm0,nb214nf_rsqMH2(%rsp)
        movaps %xmm4,nb214nf_rsqMM(%rsp)

        ## start by doing reciprocal for OO
        movaps  nb214nf_rsqOO(%rsp),%xmm7
        rcpps   %xmm7,%xmm2
        movaps  nb214nf_two(%rsp),%xmm1
        mulps   %xmm2,%xmm7
        subps   %xmm7,%xmm1
        mulps   %xmm1,%xmm2 ## rinvsq 
        movaps %xmm2,nb214nf_rinvsqOO(%rsp)

        ## next step is invsqrt - do two at a time.
        rsqrtps nb214nf_rsqH1H1(%rsp),%xmm1
        rsqrtps nb214nf_rsqH1H2(%rsp),%xmm5
        movaps  %xmm1,%xmm2
        movaps  %xmm5,%xmm6
        mulps   %xmm1,%xmm1
        mulps   %xmm5,%xmm5
        movaps  nb214nf_three(%rsp),%xmm3
        movaps  %xmm3,%xmm7
        mulps   nb214nf_rsqH1H1(%rsp),%xmm1
        mulps   nb214nf_rsqH1H2(%rsp),%xmm5
        subps   %xmm1,%xmm3
        subps   %xmm5,%xmm7
        mulps   %xmm2,%xmm3
        mulps   %xmm6,%xmm7
        mulps   nb214nf_half(%rsp),%xmm3   ## rinvH1H1 
        mulps   nb214nf_half(%rsp),%xmm7   ## rinvH1H2 
        movaps  %xmm3,nb214nf_rinvH1H1(%rsp)
        movaps  %xmm7,nb214nf_rinvH1H2(%rsp)

        rsqrtps nb214nf_rsqH1M(%rsp),%xmm1
        rsqrtps nb214nf_rsqH2H1(%rsp),%xmm5
        movaps  %xmm1,%xmm2
        movaps  %xmm5,%xmm6
        mulps   %xmm1,%xmm1
        mulps   %xmm5,%xmm5
        movaps  nb214nf_three(%rsp),%xmm3
        movaps  %xmm3,%xmm7
        mulps   nb214nf_rsqH1M(%rsp),%xmm1
        mulps   nb214nf_rsqH2H1(%rsp),%xmm5
        subps   %xmm1,%xmm3
        subps   %xmm5,%xmm7
        mulps   %xmm2,%xmm3
        mulps   %xmm6,%xmm7
        mulps   nb214nf_half(%rsp),%xmm3
        mulps   nb214nf_half(%rsp),%xmm7
        movaps  %xmm3,nb214nf_rinvH1M(%rsp)
        movaps  %xmm7,nb214nf_rinvH2H1(%rsp)

        rsqrtps nb214nf_rsqH2H2(%rsp),%xmm1
        rsqrtps nb214nf_rsqH2M(%rsp),%xmm5
        movaps  %xmm1,%xmm2
        movaps  %xmm5,%xmm6
        mulps   %xmm1,%xmm1
        mulps   %xmm5,%xmm5
        movaps  nb214nf_three(%rsp),%xmm3
        movaps  %xmm3,%xmm7
        mulps   nb214nf_rsqH2H2(%rsp),%xmm1
        mulps   nb214nf_rsqH2M(%rsp),%xmm5
        subps   %xmm1,%xmm3
        subps   %xmm5,%xmm7
        mulps   %xmm2,%xmm3
        mulps   %xmm6,%xmm7
        mulps   nb214nf_half(%rsp),%xmm3
        mulps   nb214nf_half(%rsp),%xmm7
        movaps  %xmm3,nb214nf_rinvH2H2(%rsp)
        movaps  %xmm7,nb214nf_rinvH2M(%rsp)

        rsqrtps nb214nf_rsqMH1(%rsp),%xmm1
        rsqrtps nb214nf_rsqMH2(%rsp),%xmm5
        movaps  %xmm1,%xmm2
        movaps  %xmm5,%xmm6
        mulps   %xmm1,%xmm1
        mulps   %xmm5,%xmm5
        movaps  nb214nf_three(%rsp),%xmm3
        movaps  %xmm3,%xmm7
        mulps   nb214nf_rsqMH1(%rsp),%xmm1
        mulps   nb214nf_rsqMH2(%rsp),%xmm5
        subps   %xmm1,%xmm3
        subps   %xmm5,%xmm7
        mulps   %xmm2,%xmm3
        mulps   %xmm6,%xmm7
        mulps   nb214nf_half(%rsp),%xmm3
        mulps   nb214nf_half(%rsp),%xmm7
        movaps  %xmm3,nb214nf_rinvMH1(%rsp)
        movaps  %xmm7,nb214nf_rinvMH2(%rsp)

        rsqrtps nb214nf_rsqMM(%rsp),%xmm1
        movaps  %xmm1,%xmm2
        mulps   %xmm1,%xmm1
        movaps  nb214nf_three(%rsp),%xmm3
        mulps   nb214nf_rsqMM(%rsp),%xmm1
        subps   %xmm1,%xmm3
        mulps   %xmm2,%xmm3
        mulps   nb214nf_half(%rsp),%xmm3
        movaps  %xmm3,nb214nf_rinvMM(%rsp)

        ## start with OO LJ interaction
        movaps nb214nf_rinvsqOO(%rsp),%xmm0
        movaps %xmm0,%xmm1
        mulps  %xmm1,%xmm1      ## rinv4
        mulps  %xmm0,%xmm1      ## xmm1=rinvsix 
        movaps %xmm1,%xmm2
        mulps  %xmm2,%xmm2      ## xmm2=rinvtwelve 
        mulps  nb214nf_c6(%rsp),%xmm1
        mulps  nb214nf_c12(%rsp),%xmm2
        movaps %xmm2,%xmm4
        subps  %xmm1,%xmm4
        addps  nb214nf_Vvdwtot(%rsp),%xmm4
        movaps %xmm4,nb214nf_Vvdwtot(%rsp)

        ## Coulomb interactions 
        ## add all H-H rsq in xmm2, H-M rsq xmm4
        ## H-H rinv in xmm0, H-M in xmm1
        movaps nb214nf_rinvH1H1(%rsp),%xmm0
        movaps nb214nf_rinvH1M(%rsp),%xmm1
        movaps nb214nf_rsqH1H1(%rsp),%xmm2
        movaps nb214nf_rsqH1M(%rsp),%xmm4
        addps  nb214nf_rinvH1H2(%rsp),%xmm0
        addps  nb214nf_rinvH2M(%rsp),%xmm1
        addps  nb214nf_rsqH1H2(%rsp),%xmm2
        addps  nb214nf_rsqH2M(%rsp),%xmm4
        addps  nb214nf_rinvH2H1(%rsp),%xmm0
        addps  nb214nf_rinvMH1(%rsp),%xmm1
        addps  nb214nf_rsqH2H1(%rsp),%xmm2
        addps  nb214nf_rsqMH1(%rsp),%xmm4
        addps  nb214nf_rinvH2H2(%rsp),%xmm0
        addps  nb214nf_rinvMH2(%rsp),%xmm1
        addps  nb214nf_rsqH2H2(%rsp),%xmm2
        addps  nb214nf_rsqMH2(%rsp),%xmm4
        movaps nb214nf_krf(%rsp),%xmm5
        movaps nb214nf_crf(%rsp),%xmm6
        ...
        mulps  nb214nf_qqHH(%rsp),%xmm0
        mulps  nb214nf_qqMH(%rsp),%xmm1
        addps  %xmm1,%xmm0
        addps  nb214nf_vctot(%rsp),%xmm0
        ## M-M interaction
        movaps nb214nf_rinvMM(%rsp),%xmm4
        mulps  nb214nf_rsqMM(%rsp),%xmm5   ## krsq
        addps  %xmm4,%xmm5                 ## rinv+krsq
        subps nb214nf_crf(%rsp),%xmm5   ## xmm5=rinv+ krsq-crf 
        mulps nb214nf_qqMM(%rsp),%xmm5
        addps %xmm0,%xmm5
        movaps %xmm5,nb214nf_vctot(%rsp)

        ## should we do one more iteration? 
        subl $4,nb214nf_innerk(%rsp)
        jl    _nb_kernel214nf_x86_64_sse.nb214nf_single_check
        jmp   _nb_kernel214nf_x86_64_sse.nb214nf_unroll_loop
_nb_kernel214nf_x86_64_sse.nb214nf_single_check: 
        addl $4,nb214nf_innerk(%rsp)
        jnz   _nb_kernel214nf_x86_64_sse.nb214nf_single_loop
        jmp   _nb_kernel214nf_x86_64_sse.nb214nf_updateouterdata
_nb_kernel214nf_x86_64_sse.nb214nf_single_loop: 
        movq  nb214nf_innerjjnr(%rsp),%rdx      ## pointer to jjnr[k] 
        movl  (%rdx),%eax
        addq $4,nb214nf_innerjjnr(%rsp)
        ...
        ## store all j coordinates in jO  
        movaps %xmm6,nb214nf_jxO(%rsp)
        movaps %xmm3,nb214nf_jyO(%rsp)
        movaps %xmm1,nb214nf_jzO(%rsp)
        ...
        subps  nb214nf_jyO(%rsp),%xmm1
        subps  nb214nf_jzO(%rsp),%xmm2
        subps  nb214nf_jxO(%rsp),%xmm3
        subps  nb214nf_jyO(%rsp),%xmm4
        subps  nb214nf_jzO(%rsp),%xmm5
        ...
        rcpss  %xmm0,%xmm1
        rsqrtps %xmm4,%xmm5
        movss  nb214nf_two(%rsp),%xmm2
        movaps  %xmm5,%xmm6
        mulss  %xmm1,%xmm0
        mulps   %xmm5,%xmm5
        subss  %xmm0,%xmm2
        movaps  nb214nf_three(%rsp),%xmm7
        mulss  %xmm1,%xmm2      ## 1/r2
        ...
        mulps   %xmm6,%xmm7
        mulss  %xmm0,%xmm2      ## 1/r6
        mulps   nb214nf_half(%rsp),%xmm7   ## rinv iH1 - j water 
        movss  %xmm2,%xmm1
        movaps %xmm7,nb214nf_rinvMM(%rsp)

        mulss  %xmm2,%xmm2      ## 1/r12
        mulss  nb214nf_c6(%rsp),%xmm1
        mulss  nb214nf_c12(%rsp),%xmm2
        movss  %xmm2,%xmm3
        subss  %xmm1,%xmm3
        addss  nb214nf_Vvdwtot(%rsp),%xmm3
        movss  %xmm3,nb214nf_Vvdwtot(%rsp)

        ## do  M coulomb interaction
        movaps nb214nf_rinvMM(%rsp),%xmm7
        movaps nb214nf_krf(%rsp),%xmm6

        ## fetch charges to xmm3 (temporary) 
        xorps  %xmm3,%xmm3
        movss   nb214nf_qqMH(%rsp),%xmm3
        movhps  nb214nf_qqMM(%rsp),%xmm3
        shufps $193,%xmm3,%xmm3 ## 11000001 

        mulps  nb214nf_rsqMM(%rsp),%xmm6   ## xmm6=krsq 
        addps  %xmm7,%xmm6      ## xmm6=rinv+ krsq 
        subps  nb214nf_crf(%rsp),%xmm6
        mulps  %xmm3,%xmm6 ## xmm6=voul=qq*(rinv+ krsq-crf) 
        addps  nb214nf_vctot(%rsp),%xmm6
        movaps %xmm6,nb214nf_vctot(%rsp)

        ## i H1 & H2 simultaneously first get i particle coords: 
        movaps  nb214nf_ixH1(%rsp),%xmm0
        movaps  nb214nf_iyH1(%rsp),%xmm1
        movaps  nb214nf_izH1(%rsp),%xmm2
        movaps  nb214nf_ixH2(%rsp),%xmm3
        movaps  nb214nf_iyH2(%rsp),%xmm4
        movaps  nb214nf_izH2(%rsp),%xmm5
        subps   nb214nf_jxO(%rsp),%xmm0
        subps   nb214nf_jyO(%rsp),%xmm1
        subps   nb214nf_jzO(%rsp),%xmm2
        subps   nb214nf_jxO(%rsp),%xmm3
        ...
        addps %xmm2,%xmm0       ## have rsqH1 in xmm0 
        addps %xmm5,%xmm4       ## have rsqH2 in xmm4 
        movaps  %xmm0,nb214nf_rsqH1H1(%rsp)
        movaps  %xmm4,nb214nf_rsqH2H2(%rsp)
        ...
        mulps   %xmm6,%xmm7
        mulps   nb214nf_half(%rsp),%xmm3   ## rinvH1H1
        mulps   nb214nf_half(%rsp),%xmm7   ## rinvH2H2
        movaps  %xmm3,nb214nf_rinvH1H1(%rsp)
        movaps  %xmm7,nb214nf_rinvH2H2(%rsp)

        ## Do H1 coulomb interaction
        movaps nb214nf_rinvH1H1(%rsp),%xmm7
        movaps nb214nf_krf(%rsp),%xmm6

        ## fetch charges to xmm3 (temporary) 
        xorps  %xmm3,%xmm3
        movss   nb214nf_qqHH(%rsp),%xmm3
        movhps  nb214nf_qqMH(%rsp),%xmm3
        shufps $193,%xmm3,%xmm3 ## 11000001 

        mulps  nb214nf_rsqH1H1(%rsp),%xmm6   ## xmm6=krsq 
        addps  %xmm7,%xmm6      ## xmm6=rinv+ krsq 
        subps  nb214nf_crf(%rsp),%xmm6
        mulps  %xmm3,%xmm6 ## xmm6=voul=qq*(rinv+ krsq-crf) 
        addps  nb214nf_vctot(%rsp),%xmm6
        ...
        ## H2 Coulomb
        movaps nb214nf_rinvH2H2(%rsp),%xmm7
        movaps nb214nf_krf(%rsp),%xmm6
        ...
        mulps  nb214nf_rsqH2H2(%rsp),%xmm6   ## xmm6=krsq 
        addps  %xmm7,%xmm6      ## xmm6=rinv+ krsq 
        subps  nb214nf_crf(%rsp),%xmm6
        mulps  %xmm3,%xmm6 ## xmm6=voul=qq*(rinv+ krsq-crf) 
        addps  nb214nf_vctot(%rsp),%xmm6   ## local vctot summation variable
        movaps %xmm6,nb214nf_vctot(%rsp)
        decl nb214nf_innerk(%rsp)
        jz    _nb_kernel214nf_x86_64_sse.nb214nf_updateouterdata
        jmp   _nb_kernel214nf_x86_64_sse.nb214nf_single_loop
_nb_kernel214nf_x86_64_sse.nb214nf_updateouterdata: 
        ## get n from stack
        ...
        ## accumulate total lj energy and update it 
        movaps nb214nf_Vvdwtot(%rsp),%xmm7
        ## accumulate 
        movhlps %xmm7,%xmm6
        addps  %xmm6,%xmm7      ## pos 0-1 in xmm7 have the sum now 
        movaps %xmm7,%xmm6
        ...
        incl %esi
        subl %esi,%ecx
        jz _nb_kernel214nf_x86_64_sse.nb214nf_outerend

        ## not last, iterate outer loop once more!  
        movl %esi,nb214nf_n(%rsp)
        jmp _nb_kernel214nf_x86_64_sse.nb214nf_outer
_nb_kernel214nf_x86_64_sse.nb214nf_outerend: 
        ## check if more outer neighborlists remain
        movl  nb214nf_nri(%rsp),%ecx
        ## esi already loaded with n above
        subl  %esi,%ecx
        jz _nb_kernel214nf_x86_64_sse.nb214nf_end
        ## non-zero, do one more workunit
        jmp   _nb_kernel214nf_x86_64_sse.nb214nf_threadloop
_nb_kernel214nf_x86_64_sse.nb214nf_end: 
