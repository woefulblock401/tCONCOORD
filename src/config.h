...
#define BUILD_MACHINE "Linux 2.6.22.19-0.1-default x86_64"

/* Date and time for build */
#define BUILD_TIME "Fri Jun  5 16:44:14 CEST 2009"

/* User doing build */
#define BUILD_USER "dseelig@rotbein"
...
/* Use (hacked) Gamess-UK for QM-MM calculations */
/* #undef GMX_QMMM_GAMESS */

/* Use (hacked) Gaussian0x for QM-MM calculations */
#define GMX_QMMM_GAUSSIAN 

/* Use (hacked) Mopac 7 for QM-MM calculations */
...
#define PACKAGE_STRING "GROMACS 3.3.3"
